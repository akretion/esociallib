...
#   ('--no-process-includes', '')
#   ('-o', 'esociallib/v2_04/evtTabProcesso.py')
#
# Command line arguments:
#   schemas/v2_04/evtTabProcesso.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "esociallib/v2_04/evtTabProcesso.py" schemas/v2_04/evtTabProcesso.xsd
#
...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtTabProcesso is not None:
            self.evtTabProcesso.export(outfile, level, namespace_, name_='evtTabProcesso', pretty_print=pretty_print)
...
class evtTabProcesso(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtTabProcesso)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtTabProcesso.subclass:
            return evtTabProcesso.subclass(*args_, **kwargs_)
        else:
            return evtTabProcesso(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='evtTabProcesso', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtTabProcesso')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='evtTabProcesso')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='evtTabProcesso', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='evtTabProcesso'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespace_='', name_='evtTabProcesso', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoProcesso is not None:
            self.infoProcesso.export(outfile, level, namespace_, name_='infoProcesso', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ideEvento':
            ...
            obj_ = infoProcesso.factory()
            obj_.build(child_)
            self.infoProcesso = obj_
            obj_.original_tagname_ = 'infoProcesso'
# end class evtTabProcesso


class infoProcesso(GeneratedsSuper):
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoProcesso)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoProcesso.subclass:
            return infoProcesso.subclass(*args_, **kwargs_)
        else:
            return infoProcesso(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='infoProcesso', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoProcesso')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='infoProcesso')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='infoProcesso', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='infoProcesso'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='infoProcesso', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class inclusao(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='inclusao', fromsubclass_=False, pretty_print=True):
        ...
        if self.ideProcesso is not None:
            self.ideProcesso.export(outfile, level, namespace_, name_='ideProcesso', pretty_print=pretty_print)
        if self.dadosProc is not None:
            self.dadosProc.export(outfile, level, namespace_, name_='dadosProc', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class TIdeProcesso(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='TIdeProcesso', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='TIdeProcesso')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='TIdeProcesso', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='TIdeProcesso'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='TIdeProcesso', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TDadosProc(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, indAutoria=None, indMatProc=None, dadosProcJud=None, infoSusp=None):
        self.original_tagname_ = None
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='TDadosProc', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='TDadosProc')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='TDadosProc', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='TDadosProc'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='TDadosProc', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.indAutoria is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sindAutoria>%s</%sindAutoria>%s' % (namespace_, self.gds_format_integer(self.indAutoria, input_name='indAutoria'), namespace_, eol_))
        if self.indMatProc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sindMatProc>%s</%sindMatProc>%s' % (namespace_, self.gds_format_integer(self.indMatProc, input_name='indMatProc'), namespace_, eol_))
        if self.dadosProcJud is not None:
            self.dadosProcJud.export(outfile, level, namespace_, name_='dadosProcJud', pretty_print=pretty_print)
        for infoSusp_ in self.infoSusp:
            infoSusp_.export(outfile, level, namespace_, name_='infoSusp', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'indAutoria':
            ...
            try:
                ...
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'indAutoria')
            self.indAutoria = ival_
            ...
            try:
                ...
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'indMatProc')
            self.indMatProc = ival_
        elif nodeName_ == 'dadosProcJud':
            obj_ = dadosProcJud.factory()
            obj_.build(child_)
            self.dadosProcJud = obj_
            obj_.original_tagname_ = 'dadosProcJud'
        elif nodeName_ == 'infoSusp':
            obj_ = infoSusp.factory()
            obj_.build(child_)
...
class indAutoria(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, indAutoria)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if indAutoria.subclass:
            return indAutoria.subclass(*args_, **kwargs_)
        else:
            return indAutoria(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='indAutoria', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('indAutoria')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='indAutoria')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='indAutoria', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='indAutoria'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='indAutoria', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class indAutoria


class indMatProc(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, indMatProc)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if indMatProc.subclass:
            return indMatProc.subclass(*args_, **kwargs_)
        else:
            return indMatProc(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='indMatProc', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('indMatProc')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='indMatProc')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='indMatProc', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='indMatProc'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='indMatProc', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class indMatProc


class dadosProcJud(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, dadosProcJud)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if dadosProcJud.subclass:
            return dadosProcJud.subclass(*args_, **kwargs_)
        else:
            return dadosProcJud(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='dadosProcJud', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('dadosProcJud')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='dadosProcJud')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='dadosProcJud', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='dadosProcJud'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='dadosProcJud', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.ufVara is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sufVara>%s</%sufVara>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.ufVara), input_name='ufVara')), namespace_, eol_))
        ...
        if self.idVara is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sidVara>%s</%sidVara>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.idVara), input_name='idVara')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ufVara':
            ...
            self.codMunic = ival_
        elif nodeName_ == 'idVara':
            idVara_ = child_.text
            idVara_ = self.gds_validate_string(idVara_, node, 'idVara')
            self.idVara = idVara_
# end class dadosProcJud


class ufVara(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, ufVara)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if ufVara.subclass:
            return ufVara.subclass(*args_, **kwargs_)
        else:
            return ufVara(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='ufVara', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('ufVara')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='ufVara')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='ufVara', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='ufVara'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='ufVara', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class idVara(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, idVara)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if idVara.subclass:
            return idVara.subclass(*args_, **kwargs_)
        else:
            return idVara(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='idVara', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('idVara')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='idVara')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='idVara', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='idVara'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='idVara', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class infoSusp(GeneratedsSuper):
    """Informações de suspensão de exigibilidade de tributos e FGTS em
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoSusp)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoSusp.subclass:
            return infoSusp.subclass(*args_, **kwargs_)
        else:
            return infoSusp(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='infoSusp', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoSusp')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='infoSusp')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='infoSusp', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='infoSusp'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='infoSusp', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.indSusp is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sindSusp>%s</%sindSusp>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.indSusp), input_name='indSusp')), namespace_, eol_))
        if self.dtDecisao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdtDecisao>%s</%sdtDecisao>%s' % (namespace_, self.gds_format_date(self.dtDecisao, input_name='dtDecisao'), namespace_, eol_))
        if self.indDeposito is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sindDeposito>%s</%sindDeposito>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.indDeposito), input_name='indDeposito')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class indSusp(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, indSusp)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if indSusp.subclass:
            return indSusp.subclass(*args_, **kwargs_)
        else:
            return indSusp(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='indSusp', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('indSusp')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='indSusp')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='indSusp', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='indSusp'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='indSusp', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class dtDecisao(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, dtDecisao)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if dtDecisao.subclass:
            return dtDecisao.subclass(*args_, **kwargs_)
        else:
            return dtDecisao(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='dtDecisao', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('dtDecisao')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='dtDecisao')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='dtDecisao', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='dtDecisao'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='dtDecisao', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class indDeposito(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, indDeposito)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if indDeposito.subclass:
            return indDeposito.subclass(*args_, **kwargs_)
        else:
            return indDeposito(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='indDeposito', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('indDeposito')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='indDeposito')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='indDeposito', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='indDeposito'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='indDeposito', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
