...
#   ('--no-process-includes', '')
#   ('-o', 'esociallib/v2_04/evtDeslig.py')
#
# Command line arguments:
#   schemas/v2_04/evtDeslig.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "esociallib/v2_04/evtDeslig.py" schemas/v2_04/evtDeslig.xsd
#
...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtDeslig is not None:
            self.evtDeslig.export(outfile, level, namespace_, name_='evtDeslig', pretty_print=pretty_print)
...
class evtDeslig(GeneratedsSuper):
    """Evento Desligamento"""
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtDeslig)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtDeslig.subclass:
            return evtDeslig.subclass(*args_, **kwargs_)
        else:
            return evtDeslig(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='evtDeslig', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtDeslig')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='evtDeslig')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='evtDeslig', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='evtDeslig'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespace_='', name_='evtDeslig', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.infoDeslig is not None:
            self.infoDeslig.export(outfile, level, namespace_, name_='infoDeslig', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class infoDeslig(GeneratedsSuper):
    """Apresenta as informações relativas ao desligamento do vínculo
    identificado no registro superior."""
    subclass = None
    superclass = None
    def __init__(self, mtvDeslig=None, dtDeslig=None, indPagtoAPI=None, dtProjFimAPI=None, pensAlim=None, percAliment=None, vrAlim=None, nrCertObito=None, nrProcTrab=None, indCumprParc=None, observacao=None, sucessaoVinc=None, transfTit=None, verbasResc=None, quarentena=None, consigFGTS=None):
        self.original_tagname_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, infoDeslig)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if infoDeslig.subclass:
            return infoDeslig.subclass(*args_, **kwargs_)
        else:
            return infoDeslig(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            self.consigFGTS is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='', name_='infoDeslig', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('infoDeslig')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='infoDeslig')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='infoDeslig', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='infoDeslig'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='infoDeslig', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.mtvDeslig is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%smtvDeslig>%s</%smtvDeslig>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.mtvDeslig), input_name='mtvDeslig')), namespace_, eol_))
        ...
        if self.indPagtoAPI is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sindPagtoAPI>%s</%sindPagtoAPI>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.indPagtoAPI), input_name='indPagtoAPI')), namespace_, eol_))
        if self.dtProjFimAPI is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdtProjFimAPI>%s</%sdtProjFimAPI>%s' % (namespace_, self.gds_format_date(self.dtProjFimAPI, input_name='dtProjFimAPI'), namespace_, eol_))
        if self.pensAlim is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%spensAlim>%s</%spensAlim>%s' % (namespace_, self.gds_format_integer(self.pensAlim, input_name='pensAlim'), namespace_, eol_))
        if self.percAliment is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%spercAliment>%s</%spercAliment>%s' % (namespace_, self.gds_format_float(self.percAliment, input_name='percAliment'), namespace_, eol_))
        if self.vrAlim is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%svrAlim>%s</%svrAlim>%s' % (namespace_, self.gds_format_float(self.vrAlim, input_name='vrAlim'), namespace_, eol_))
        if self.nrCertObito is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snrCertObito>%s</%snrCertObito>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.nrCertObito), input_name='nrCertObito')), namespace_, eol_))
        if self.nrProcTrab is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snrProcTrab>%s</%snrProcTrab>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.nrProcTrab), input_name='nrProcTrab')), namespace_, eol_))
        if self.indCumprParc is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sindCumprParc>%s</%sindCumprParc>%s' % (namespace_, self.gds_format_integer(self.indCumprParc, input_name='indCumprParc'), namespace_, eol_))
        ...
        if self.transfTit is not None:
            self.transfTit.export(outfile, level, namespace_, name_='transfTit', pretty_print=pretty_print)
        ...
        if self.consigFGTS is not None:
            self.consigFGTS.export(outfile, level, namespace_, name_='consigFGTS', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'mtvDeslig':
            ...
            ival_ = self.gds_validate_integer(ival_, node, 'pensAlim')
            self.pensAlim = ival_
        elif nodeName_ == 'percAliment':
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:
            ...
            try:
                ...
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'indCumprParc')
            self.indCumprParc = ival_
            ...
            obj_ = consigFGTS.factory()
            obj_.build(child_)
            self.consigFGTS = obj_
            obj_.original_tagname_ = 'consigFGTS'
# end class infoDeslig


class mtvDeslig(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, mtvDeslig)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if mtvDeslig.subclass:
            return mtvDeslig.subclass(*args_, **kwargs_)
        else:
            return mtvDeslig(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='mtvDeslig', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('mtvDeslig')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='mtvDeslig')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='mtvDeslig', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='mtvDeslig'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='mtvDeslig', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class indPagtoAPI(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, indPagtoAPI)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if indPagtoAPI.subclass:
            return indPagtoAPI.subclass(*args_, **kwargs_)
        else:
            return indPagtoAPI(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='indPagtoAPI', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('indPagtoAPI')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='indPagtoAPI')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='indPagtoAPI', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='indPagtoAPI'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='indPagtoAPI', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class indPagtoAPI


class dtProjFimAPI(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, dtProjFimAPI)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if dtProjFimAPI.subclass:
            return dtProjFimAPI.subclass(*args_, **kwargs_)
        else:
            return dtProjFimAPI(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='dtProjFimAPI', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('dtProjFimAPI')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='dtProjFimAPI')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='dtProjFimAPI', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='dtProjFimAPI'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='dtProjFimAPI', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class dtProjFimAPI


class pensAlim(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, pensAlim)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if pensAlim.subclass:
            return pensAlim.subclass(*args_, **kwargs_)
        else:
            return pensAlim(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='pensAlim', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('pensAlim')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='pensAlim')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='pensAlim', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='pensAlim'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='pensAlim', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class percAliment(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, percAliment)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if percAliment.subclass:
            return percAliment.subclass(*args_, **kwargs_)
        else:
            return percAliment(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='percAliment', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('percAliment')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='percAliment')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='percAliment', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='percAliment'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='percAliment', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class percAliment


class vrAlim(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, vrAlim)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if vrAlim.subclass:
            return vrAlim.subclass(*args_, **kwargs_)
        else:
            return vrAlim(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='vrAlim', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('vrAlim')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='vrAlim')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='vrAlim', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='vrAlim'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='vrAlim', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class nrCertObito(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, nrCertObito)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if nrCertObito.subclass:
            return nrCertObito.subclass(*args_, **kwargs_)
        else:
            return nrCertObito(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='nrCertObito', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('nrCertObito')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='nrCertObito')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='nrCertObito', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='nrCertObito'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='nrCertObito', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class nrCertObito


class nrProcTrab(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, nrProcTrab)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if nrProcTrab.subclass:
            return nrProcTrab.subclass(*args_, **kwargs_)
        else:
            return nrProcTrab(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='nrProcTrab', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('nrProcTrab')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='nrProcTrab')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='nrProcTrab', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='nrProcTrab'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='nrProcTrab', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class nrProcTrab


class indCumprParc(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, indCumprParc)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if indCumprParc.subclass:
            return indCumprParc.subclass(*args_, **kwargs_)
        else:
            return indCumprParc(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='indCumprParc', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('indCumprParc')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='indCumprParc')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='indCumprParc', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='indCumprParc'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='indCumprParc', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class sucessaoVinc(GeneratedsSuper):
    """Registro preenchido exclusivamente nos casos de sucessão do vínculo
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='sucessaoVinc', fromsubclass_=False, pretty_print=True):
        ...
        if self.cnpjSucessora is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scnpjSucessora>%s</%scnpjSucessora>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.cnpjSucessora), input_name='cnpjSucessora')), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class cnpjSucessora(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, cnpjSucessora)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if cnpjSucessora.subclass:
            return cnpjSucessora.subclass(*args_, **kwargs_)
        else:
            return cnpjSucessora(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='cnpjSucessora', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('cnpjSucessora')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='cnpjSucessora')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='cnpjSucessora', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='cnpjSucessora'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='cnpjSucessora', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class cnpjSucessora


class transfTit(GeneratedsSuper):
    """Transferência de titularidade do empregado doméstico para outro
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, transfTit)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if transfTit.subclass:
            return transfTit.subclass(*args_, **kwargs_)
        else:
            return transfTit(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='transfTit', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('transfTit')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='transfTit')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='transfTit', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='transfTit'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='transfTit', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.cpfSubstituto is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scpfSubstituto>%s</%scpfSubstituto>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.cpfSubstituto), input_name='cpfSubstituto')), namespace_, eol_))
...
class cpfSubstituto(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, cpfSubstituto)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if cpfSubstituto.subclass:
            return cpfSubstituto.subclass(*args_, **kwargs_)
        else:
            return cpfSubstituto(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='cpfSubstituto', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('cpfSubstituto')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='cpfSubstituto')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='cpfSubstituto', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='cpfSubstituto'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='cpfSubstituto', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class dmDev(GeneratedsSuper):
    ...
    a) da data do desligamento, informada no campo {dtDeslig} se as
    informações pertencerem ao grupo {infoPerApur}; b) informado em
    {perRef} se as informações pertencerem ao grupo {infoPerAnt}."""
    subclass = None
    superclass = None
...
class detVerbas(GeneratedsSuper):
    """Detalhamento das verbas rescisórias devidas ao trabalhador. Deve
    haver, pelo menos uma rubrica de folha, mesmo que o valor
    líquido a ser pago ao trabalhador seja 0 (zero) em função de
    descontos."""
    subclass = None
    superclass = None
...
class infoAgNocivo(GeneratedsSuper):
    ...
    trabalhador amparado pelo RGPS - Regime Geral de Previdência
    Social."""
    subclass = None
    superclass = None
...
class infoPerAnt(GeneratedsSuper):
    """Remuneração relativa a Períodos Anteriores, devida em função de
    acordos coletivos, legislação específica, convenção coletiva de
    trabalho, dissídio ou Conversão de Licença Saúde em Acidente de
    Trabalho."""
    subclass = None
    superclass = None
...
class ideADC(GeneratedsSuper):
    """Identificação do Acordo coletivo, Legislação, Convenção Coletiva,
    Dissídio ou Conversão da licença saúde em acidente de trabalho."""
    subclass = None
    superclass = None
...
class consigFGTS(GeneratedsSuper):
    """Informações sobre operação de crédito consignado com garantia de
    FGTS"""
    subclass = None
    superclass = None
    def __init__(self, idConsig=None, insConsig=None, nrContr=None):
        self.original_tagname_ = None
        self.idConsig = idConsig
        self.insConsig = insConsig
        self.nrContr = nrContr
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, consigFGTS)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if consigFGTS.subclass:
            return consigFGTS.subclass(*args_, **kwargs_)
        else:
            return consigFGTS(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_idConsig(self): return self.idConsig
    def set_idConsig(self, idConsig): self.idConsig = idConsig
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='consigFGTS', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('consigFGTS')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='consigFGTS')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='consigFGTS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='consigFGTS'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='consigFGTS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.idConsig is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sidConsig>%s</%sidConsig>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.idConsig), input_name='idConsig')), namespace_, eol_))
        if self.insConsig is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sinsConsig>%s</%sinsConsig>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.insConsig), input_name='insConsig')), namespace_, eol_))
        if self.nrContr is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snrContr>%s</%snrContr>%s' % (namespace_, self.gds_format_integer(self.nrContr, input_name='nrContr'), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'idConsig':
            idConsig_ = child_.text
            idConsig_ = self.gds_validate_string(idConsig_, node, 'idConsig')
            self.idConsig = idConsig_
        elif nodeName_ == 'insConsig':
            ...
            ival_ = self.gds_validate_integer(ival_, node, 'nrContr')
            self.nrContr = ival_
# end class consigFGTS


class idConsig(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, idConsig)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if idConsig.subclass:
            return idConsig.subclass(*args_, **kwargs_)
        else:
            return idConsig(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='idConsig', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('idConsig')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='idConsig')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='idConsig', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='idConsig'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='idConsig', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class insConsig(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, insConsig)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if insConsig.subclass:
            return insConsig.subclass(*args_, **kwargs_)
        else:
            return insConsig(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='insConsig', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('insConsig')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='insConsig')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='insConsig', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='insConsig'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='insConsig', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class nrContr(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, nrContr)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if nrContr.subclass:
            return nrContr.subclass(*args_, **kwargs_)
        else:
            return nrContr(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='nrContr', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('nrContr')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='nrContr')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='nrContr', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='nrContr'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='nrContr', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
