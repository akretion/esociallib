...
#   ('--no-process-includes', '')
#   ('-o', 'esociallib/v2_04/evtContrSindPatr.py')
#
# Command line arguments:
#   schemas/v2_04/evtContrSindPatr.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "esociallib/v2_04/evtContrSindPatr.py" schemas/v2_04/evtContrSindPatr.xsd
#
...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtContrSindPatr is not None:
            self.evtContrSindPatr.export(outfile, level, namespace_, name_='evtContrSindPatr', pretty_print=pretty_print)
...
class evtContrSindPatr(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtContrSindPatr)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtContrSindPatr.subclass:
            return evtContrSindPatr.subclass(*args_, **kwargs_)
        else:
            return evtContrSindPatr(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='evtContrSindPatr', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtContrSindPatr')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='evtContrSindPatr')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='evtContrSindPatr', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='evtContrSindPatr'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespace_='', name_='evtContrSindPatr', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for contribSind_ in self.contribSind:
            contribSind_.export(outfile, level, namespace_, name_='contribSind', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class contribSind(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, contribSind)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if contribSind.subclass:
            return contribSind.subclass(*args_, **kwargs_)
        else:
            return contribSind(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='contribSind', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('contribSind')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='contribSind')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='contribSind', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='contribSind'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='contribSind', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.cnpjSindic is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scnpjSindic>%s</%scnpjSindic>%s' % (namespace_, self.gds_encode(self.gds_format_string(quote_xml(self.cnpjSindic), input_name='cnpjSindic')), namespace_, eol_))
        if self.tpContribSind is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%stpContribSind>%s</%stpContribSind>%s' % (namespace_, self.gds_format_integer(self.tpContribSind, input_name='tpContribSind'), namespace_, eol_))
        if self.vlrContribSind is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%svlrContribSind>%s</%svlrContribSind>%s' % (namespace_, self.gds_format_float(self.vlrContribSind, input_name='vlrContribSind'), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'cnpjSindic':
            ...
            try:
                ...
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'tpContribSind')
            self.tpContribSind = ival_
        elif nodeName_ == 'vlrContribSind':
            sval_ = child_.text
            try:
                fval_ = float(sval_)
            except (TypeError, ValueError) as exp:
...
# end class contribSind


class cnpjSindic(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, cnpjSindic)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if cnpjSindic.subclass:
            return cnpjSindic.subclass(*args_, **kwargs_)
        else:
            return cnpjSindic(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='cnpjSindic', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('cnpjSindic')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='cnpjSindic')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='cnpjSindic', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='cnpjSindic'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='cnpjSindic', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class cnpjSindic


class tpContribSind(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, tpContribSind)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if tpContribSind.subclass:
            return tpContribSind.subclass(*args_, **kwargs_)
        else:
            return tpContribSind(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='tpContribSind', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('tpContribSind')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='tpContribSind')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='tpContribSind', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='tpContribSind'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='tpContribSind', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        pass
# end class tpContribSind


class vlrContribSind(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self):
        self.original_tagname_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, vlrContribSind)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if vlrContribSind.subclass:
            return vlrContribSind.subclass(*args_, **kwargs_)
        else:
            return vlrContribSind(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='vlrContribSind', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('vlrContribSind')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='vlrContribSind')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='vlrContribSind', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='vlrContribSind'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='vlrContribSind', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
