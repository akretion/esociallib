...
#   ('--no-process-includes', '')
#   ('-o', 'esociallib/v2_04/evtReabreEvPer.py')
#
# Command line arguments:
#   schemas/v2_04/evtReabreEvPer.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "esociallib/v2_04/evtReabreEvPer.py" schemas/v2_04/evtReabreEvPer.xsd
#
...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtReabreEvPer is not None:
            self.evtReabreEvPer.export(outfile, level, namespace_, name_='evtReabreEvPer', pretty_print=pretty_print)
...
class evtReabreEvPer(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtReabreEvPer)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtReabreEvPer.subclass:
            return evtReabreEvPer.subclass(*args_, **kwargs_)
        else:
            return evtReabreEvPer(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='evtReabreEvPer', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtReabreEvPer')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='evtReabreEvPer')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='evtReabreEvPer', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='evtReabreEvPer'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespace_='', name_='evtReabreEvPer', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
