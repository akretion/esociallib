...
#   ('--no-process-includes', '')
#   ('-o', 'esociallib/v2_04/evtInsApo.py')
#
# Command line arguments:
#   schemas/v2_04/evtInsApo.xsd
#
# Command line:
#   /usr/local/bin/generateDS --no-process-includes -o "esociallib/v2_04/evtInsApo.py" schemas/v2_04/evtInsApo.xsd
#
...
class eSocial(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='eSocial', fromsubclass_=False, pretty_print=True):
        ...
        if self.evtInsApo is not None:
            self.evtInsApo.export(outfile, level, namespace_, name_='evtInsApo', pretty_print=pretty_print)
...
class evtInsApo(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, evtInsApo)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if evtInsApo.subclass:
            return evtInsApo.subclass(*args_, **kwargs_)
        else:
            return evtInsApo(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='evtInsApo', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('evtInsApo')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='evtInsApo')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='evtInsApo', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='evtInsApo'):
        if self.Id is not None and 'Id' not in already_processed:
            already_processed.add('Id')
            outfile.write(' Id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.Id), input_name='Id')), ))
    def exportChildren(self, outfile, level, namespace_='', name_='evtInsApo', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.insalPeric is not None:
            self.insalPeric.export(outfile, level, namespace_, name_='insalPeric', pretty_print=pretty_print)
        if self.aposentEsp is not None:
            self.aposentEsp.export(outfile, level, namespace_, name_='aposentEsp', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class insalPeric(GeneratedsSuper):
    """Informações sobre o ambiente de trabalho insalubre/periculoso."""
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, insalPeric)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if insalPeric.subclass:
            return insalPeric.subclass(*args_, **kwargs_)
        else:
            return insalPeric(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='insalPeric', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('insalPeric')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='insalPeric')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='insalPeric', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='insalPeric'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='insalPeric', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.iniInsalPeric is not None:
            self.iniInsalPeric.export(outfile, level, namespace_, name_='iniInsalPeric', pretty_print=pretty_print)
        if self.altInsalPeric is not None:
            self.altInsalPeric.export(outfile, level, namespace_, name_='altInsalPeric', pretty_print=pretty_print)
        if self.fimInsalPeric is not None:
            self.fimInsalPeric.export(outfile, level, namespace_, name_='fimInsalPeric', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class iniInsalPeric(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, iniInsalPeric)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if iniInsalPeric.subclass:
            return iniInsalPeric.subclass(*args_, **kwargs_)
        else:
            return iniInsalPeric(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='iniInsalPeric', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('iniInsalPeric')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='iniInsalPeric')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='iniInsalPeric', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='iniInsalPeric'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='iniInsalPeric', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class altInsalPeric(GeneratedsSuper):
    """Condições do ambiente de trabalho insalubre/periculoso - Alteração"""
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, altInsalPeric)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if altInsalPeric.subclass:
            return altInsalPeric.subclass(*args_, **kwargs_)
        else:
            return altInsalPeric(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='altInsalPeric', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('altInsalPeric')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='altInsalPeric')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='altInsalPeric', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='altInsalPeric'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='altInsalPeric', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class fimInsalPeric(GeneratedsSuper):
    """Condições do ambiente de trabalho insalubre/periculoso - Fim"""
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, fimInsalPeric)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if fimInsalPeric.subclass:
            return fimInsalPeric.subclass(*args_, **kwargs_)
        else:
            return fimInsalPeric(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='fimInsalPeric', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('fimInsalPeric')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='fimInsalPeric')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='fimInsalPeric', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='fimInsalPeric'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='fimInsalPeric', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class infoAmb(GeneratedsSuper):
    """Detalha o ambiente de trabalho em que o trabalhador desempenha
...
class aposentEsp(GeneratedsSuper):
    """Informações sobre o trabalho exercido em condições que ensejam a
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, aposentEsp)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if aposentEsp.subclass:
            return aposentEsp.subclass(*args_, **kwargs_)
        else:
            return aposentEsp(*args_, **kwargs_)
    factory = staticmethod(factory)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='aposentEsp', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('aposentEsp')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='aposentEsp')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='aposentEsp', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='aposentEsp'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='aposentEsp', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.iniAposentEsp is not None:
            self.iniAposentEsp.export(outfile, level, namespace_, name_='iniAposentEsp', pretty_print=pretty_print)
        if self.altAposentEsp is not None:
            self.altAposentEsp.export(outfile, level, namespace_, name_='altAposentEsp', pretty_print=pretty_print)
        if self.fimAposentEsp is not None:
            self.fimAposentEsp.export(outfile, level, namespace_, name_='fimAposentEsp', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class iniAposentEsp(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, iniAposentEsp)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if iniAposentEsp.subclass:
            return iniAposentEsp.subclass(*args_, **kwargs_)
        else:
            return iniAposentEsp(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_dtIniCondicao(self): return self.dtIniCondicao
    def set_dtIniCondicao(self, dtIniCondicao): self.dtIniCondicao = dtIniCondicao
    def get_infoAmb(self): return self.infoAmb
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='iniAposentEsp', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('iniAposentEsp')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='iniAposentEsp')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='iniAposentEsp', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='iniAposentEsp'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='iniAposentEsp', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dtIniCondicao':
            ...
            self.infoAmb.append(obj_)
            obj_.original_tagname_ = 'infoAmb'
# end class iniAposentEsp


class altAposentEsp(GeneratedsSuper):
    """Condições do ambiente de trabalho que ensejam aposentadoria especial
    - Alteração"""
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, altAposentEsp)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if altAposentEsp.subclass:
            return altAposentEsp.subclass(*args_, **kwargs_)
        else:
            return altAposentEsp(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_dtAltCondicao(self): return self.dtAltCondicao
    def set_dtAltCondicao(self, dtAltCondicao): self.dtAltCondicao = dtAltCondicao
    def get_infoamb(self): return self.infoamb
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='altAposentEsp', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('altAposentEsp')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='altAposentEsp')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='altAposentEsp', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='altAposentEsp'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='altAposentEsp', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'dtAltCondicao':
            ...
            self.infoamb.append(obj_)
            obj_.original_tagname_ = 'infoamb'
# end class altAposentEsp


class fimAposentEsp(GeneratedsSuper):
    """Condições do ambiente de trabalho que ensejam aposentadoria especial
    - Término"""
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, fimAposentEsp)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if fimAposentEsp.subclass:
            return fimAposentEsp.subclass(*args_, **kwargs_)
        else:
            return fimAposentEsp(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_dtFimCondicao(self): return self.dtFimCondicao
    def set_dtFimCondicao(self, dtFimCondicao): self.dtFimCondicao = dtFimCondicao
    def get_infoAmb(self): return self.infoAmb
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='fimAposentEsp', namespacedef_='', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('fimAposentEsp')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='fimAposentEsp')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='fimAposentEsp', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='fimAposentEsp'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='fimAposentEsp', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class TinfoAmbiente(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='', name_='TinfoAmbiente', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='TinfoAmbiente')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='', name_='TinfoAmbiente', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='TinfoAmbiente'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='TinfoAmbiente', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
