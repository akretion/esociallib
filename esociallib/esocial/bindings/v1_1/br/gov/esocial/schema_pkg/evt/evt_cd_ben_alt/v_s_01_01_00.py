...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtCdBenAlt/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ESocial:
    ...
    :ivar evtCdBenAlt: Evento Cadastro de Benefício - Alteração
        DESCRICAO_COMPLETA:Evento Cadastro de Benefício - Entes Públicos
        - Alteração. CHAVE_GRUPO: {Id} REGRA:REGRA_ALTERA_TIPO_BENEFICIO
    ...
    evtCdBenAlt: Optional["ESocial.EvtCdBenAlt"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtCdBenAlt:
        ...
        :ivar ideEmpregador:
        :ivar ideBeneficio:
        :ivar infoBenAlteracao: Informações do benefício - Alteração.
        ...
        ideBeneficio: Optional[TIdeBeneficio] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        infoBenAlteracao: Optional["ESocial.EvtCdBenAlt.InfoBenAlteracao"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        @dataclass
        class InfoBenAlteracao:
            """
            :ivar dtAltBeneficio: Data de alteração das informações
                relativas ao benefício. Validação: Deve ser igual ou
                anterior à data atual.
            :ivar dadosBeneficio: Dados relativos ao benefício.
            """
            dtAltBeneficio: Optional[XmlDate] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            dadosBeneficio: Optional["ESocial.EvtCdBenAlt.InfoBenAlteracao.DadosBeneficio"] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            class DadosBeneficio:
                ...
                :ivar tpBeneficio: Tipo de benefício. Validação: Deve
                    ...
                    {cadIni}(2410_infoBenInicio_cadIni) em S-2410 for
                    igual a [N], não é permitido utilizar código do
                    grupo [08] dessa tabela.
                :ivar tpPlanRP:
                ...
                :ivar indSuspensao: Indicativo de suspensão do
                    benefício.
                ...
                :ivar suspensao: Informações referentes à suspensão do
                    benefício. CONDICAO_GRUPO: O (se
                    {indSuspensao}(../indSuspensao) = [S]; N (se
                ...
                indSuspensao: Optional[TsSimNao] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
                ...
                infoPenMorte: Optional["ESocial.EvtCdBenAlt.InfoBenAlteracao.DadosBeneficio.InfoPenMorte"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                )
                suspensao: Optional["ESocial.EvtCdBenAlt.InfoBenAlteracao.DadosBeneficio.Suspensao"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                ...
                class Suspensao:
                    """
                    :ivar mtvSuspensao:
                    :ivar dscSuspensao: Descrição do motivo da suspensão
                        do benefício. Validação: Preenchimento
                        obrigatório e exclusivo se
                        {mtvSuspensao}(./mtvSuspensao) = [99].
                    """
                    mtvSuspensao: Optional[SuspensaoMtvSuspensao] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                            "required": True,
                    ...
                    dscSuspensao: Optional[str] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                            "min_length": 1,
