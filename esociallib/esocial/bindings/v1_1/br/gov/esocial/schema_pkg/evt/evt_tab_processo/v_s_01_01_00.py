...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtTabProcesso/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class TDadosProcIndMatProc(Enum):
    ...
    :cvar VALUE_7: Exclusivamente FGTS e/ou Contribuição Social
        Rescisória (Lei Complementar 110/2001)
    """
    VALUE_1 = 1
    VALUE_7 = 7
...
class InfoSuspIndSusp(Enum):
    ...
    :cvar VALUE_08: Sentença em mandado de segurança favorável ao
        contribuinte
    :cvar VALUE_09: Sentença em ação ordinária favorável ao contribuinte
        e confirmada pelo TRF
    :cvar VALUE_10: Acórdão do TRF favorável ao contribuinte
    :cvar VALUE_11: Acórdão do STJ em recurso especial favorável ao
        contribuinte
    :cvar VALUE_12: Acórdão do STF em recurso extraordinário favorável
        ao contribuinte
    :cvar VALUE_13: Sentença 1ª instância não transitada em julgado com
        efeito suspensivo
...
class TDadosProc:
    ...
    :ivar dadosProcJud: Informações complementares do processo judicial.
        CONDICAO_GRUPO: O (se
    ...
    :ivar infoSusp: Informações de suspensão de exigibilidade de
        tributos DESCRICAO_COMPLETA:Informações de suspensão de
        exigibilidade de tributos em virtude de processo administrativo
        ou judicial. CHAVE_GRUPO: {codSusp} CONDICAO_GRUPO: O (se
        {indMatProc}(1070_infoProcesso_inclusao_dadosProc_indMatProc) =
        [1]); N (nos demais casos)
    """
    class Meta:
    ...
    indAutoria: Optional[TDadosProcIndAutoria] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtTabProcesso/v_S_01_01_00",
    ...
    indMatProc: Optional[TDadosProcIndMatProc] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtTabProcesso/v_S_01_01_00",
    ...
    dadosProcJud: Optional["TDadosProc.DadosProcJud"] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtTabProcesso/v_S_01_01_00",
    ...
    class DadosProcJud:
        """
        :ivar ufVara: Identificação da Unidade da Federação - UF da
            Seção Judiciária.
        :ivar codMunic:
        :ivar idVara:
        """
    ...
    class InfoSusp:
        """
        :ivar codSusp: Código do indicativo da suspensão, atribuído pelo
            empregador.
        :ivar indSusp:
        :ivar dtDecisao: Data da decisão, sentença ou despacho
            administrativo.
        :ivar indDeposito: Indicativo de depósito do montante integral.
            Validação: Se
            {indSusp}(1070_infoProcesso_inclusao_dadosProc_infoSusp_indSusp)
            = [90], preencher obrigatoriamente com [N]. Se
            {indSusp}(1070_infoProcesso_inclusao_dadosProc_infoSusp_indSusp)
        ...
        indSusp: Optional[InfoSuspIndSusp] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.esocial.gov.br/schema/evt/evtTabProcesso/v_S_01_01_00",
        ...
        dtDecisao: Optional[XmlDate] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.esocial.gov.br/schema/evt/evtTabProcesso/v_S_01_01_00",
        ...
        indDeposito: Optional[TsSimNao] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.esocial.gov.br/schema/evt/evtTabProcesso/v_S_01_01_00",
...
class TIdeProcesso:
    ...
    :ivar nrProc: Informar o número do processo administrativo/judicial
        de acordo com o tipo informado em {tpProc}(./tpProc). Validação:
        Deve ser um número de processo válido e: a) Se
        {tpProc}(./tpProc) = [1], deve possuir 17 (dezessete) ou 21
        (vinte e um) algarismos; b) Se {tpProc}(./tpProc) = [2], deve
        possuir 20 (vinte) algarismos; c) Se {tpProc}(./tpProc) = [4],
        deve possuir 16 (dezesseis) algarismos.
    :ivar iniValid:
    :ivar fimValid:
    """
    class Meta:
...
class ESocial:
    ...
    :ivar evtTabProcesso: Evento Tabela de Processos
        DESCRICAO_COMPLETA:Evento Tabela de Processos
        Administrativos/Judiciais. CHAVE_GRUPO: {Id}
    ...
    evtTabProcesso: Optional["ESocial.EvtTabProcesso"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtTabProcesso:
        ...
        infoProcesso: Optional["ESocial.EvtTabProcesso.InfoProcesso"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class InfoProcesso:
            ...
            """
            inclusao: Optional["ESocial.EvtTabProcesso.InfoProcesso.Inclusao"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            alteracao: Optional["ESocial.EvtTabProcesso.InfoProcesso.Alteracao"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            exclusao: Optional["ESocial.EvtTabProcesso.InfoProcesso.Exclusao"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            ...
            @dataclass
            class Inclusao:
                ideProcesso: Optional[TIdeProcesso] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
                ...
                dadosProc: Optional[TDadosProc] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
