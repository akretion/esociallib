...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtComProd/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ESocial:
    ...
    :ivar evtComProd: Evento Comercialização da Produção Rural Pessoa
        Física. CHAVE_GRUPO: {Id} REGRA:REGRA_ENVIO_PROC_FECHAMENTO
        REGRA:REGRA_EVENTOS_EXTEMP REGRA:REGRA_EVE_FOPAG_COMERC_PROD
    ...
    evtComProd: Optional["ESocial.EvtComProd"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtComProd:
        ...
        :ivar Id:
        """
        ideEvento: Optional[TIdeEventoFolhaMensalPf] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        ideEmpregador: Optional["ESocial.EvtComProd.IdeEmpregador"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        infoComProd: Optional["ESocial.EvtComProd.InfoComProd"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class IdeEmpregador:
            """
            :ivar tpInsc:
            :ivar nrInsc: Informar o número de inscrição do contribuinte
                de acordo com o tipo de inscrição indicado no campo
                {ideEmpregador/tpInsc}(./tpInsc) e conforme informado em
                S-1000.
            """
            tpInsc: Optional[TsTpInsc2] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
        ...
        class InfoComProd:
            """
            :ivar ideEstabel: Identificação do estabelecimento que
                comercializou a produção. CHAVE_GRUPO:
                {nrInscEstabRural*}
            """
            ideEstabel: Optional["ESocial.EvtComProd.InfoComProd.IdeEstabel"] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            class IdeEstabel:
                ...
                :ivar tpComerc: Valor total da comercialização por
                    "tipo" de comercialização. CHAVE_GRUPO: {indComerc}
                """
                nrInscEstabRural: Optional[str] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
                ...
                class TpComerc:
                    ...
                    :ivar vrTotCom: Preencher com o valor total da
                        comercialização. Validação: Deve ser maior que 0
                        (zero).
                    :ivar ideAdquir: Identificação dos adquirentes da
                        produção. CHAVE_GRUPO: {tpInsc}, {nrInsc}
                        CONDICAO_GRUPO: F (se {indComerc}(../indComerc)
                        = [3, 7, 8]); N (nos demais casos)
                    :ivar infoProcJud: Informação de processos judiciais
                        DESCRICAO_COMPLETA:Informações de processos
                        judiciais com decisão/sentença favorável ao
                        contribuinte e relativos à contribuição
                        incidente sobre a comercialização. CHAVE_GRUPO:
                        {tpProc}, {nrProc}, {codSusp} CONDICAO_GRUPO: OC
                    """
                    ...
                    vrTotCom: Optional[Decimal] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                            "required": True,
                    ...
                    class IdeAdquir:
                        """
                        :ivar tpInsc: Preencher com o código
                            correspondente ao tipo de inscrição,
                            conforme Tabela 05. Validação: Se
                            {indComerc}(../indComerc) for igual a [3,
                            7], deve ser igual a [1, 2]. Se
                            {indComerc}(../indComerc) for igual a [8],
                            deve ser igual a [1].
                        :ivar nrInsc: Informar o número de inscrição do
                            contribuinte de acordo com o tipo de
                            inscrição indicado no campo
                            {ideAdquir/tpInsc}(./tpInsc). Validação: A
                            inscrição informada deve ser compatível com
                            o {ideAdquir/tpInsc}(./tpInsc) e diferente
                            da inscrição do declarante.
                        :ivar vrComerc: Valor bruto da comercialização
                            da produção. Validação: Deve ser maior que 0
                            (zero).
                        :ivar nfs: Notas fiscais da aquisição de
                            produção DESCRICAO_COMPLETA:Detalhamento das
                            notas fiscais relativas à comercialização de
                            produção com o adquirente identificado no
                            grupo superior. CHAVE_GRUPO: {serie},
                            {nrDocto} CONDICAO_GRUPO: F
                        """
                        tpInsc: Optional[TsTpInsc12] = field(
                            default=None,
                            metadata={
                        ...
                        vrComerc: Optional[Decimal] = field(
                            default=None,
                            metadata={
                                "type": "Element",
                                "required": True,
                        ...
                        class Nfs:
                            ...
                            :ivar serie:
                            :ivar nrDocto:
                            :ivar dtEmisNF: Data de emissão da nota
                                fiscal/fatura. Validação: O mês/ano da
                                emissão da nota fiscal deve ser igual ao
                                mês/ano indicado no registro de abertura
                                do arquivo.
                            :ivar vlrBruto: Preencher com o valor bruto
                                da(s) nota(s) fiscal(is).
                            :ivar vrCPDescPR: Preencher com o valor da
                                contribuição previdenciária descontada
                                pelo adquirente na comercialização de
                                produção. Se não houver informação,
                                preencher com 0 (zero).
                            :ivar vrRatDescPR: Valor da contribuição
                                destinada ao financiamento dos
                                benefícios concedidos em razão do grau
                                de incidência da incapacidade laborativa
                                decorrente dos riscos ambientais do
                                trabalho, incidente sobre a
                                comercialização de produção rural de
                                produtor rural. Se não houver
                                informação, preencher com 0 (zero).
                            :ivar vrSenarDesc: Valor da contribuição
                                destinada ao SENAR, incidente sobre a
                                comercialização de produção rural de
                                produtor rural pessoa física/segurado
                                especial. Se não houver informação,
                                preencher com 0 (zero).
                            """
                            ...
                            dtEmisNF: Optional[XmlDate] = field(
                                default=None,
                                metadata={
                                    "type": "Element",
                                    "required": True,
                            ...
                            vlrBruto: Optional[Decimal] = field(
                                default=None,
                                metadata={
                                    "type": "Element",
                                    "required": True,
                    ...
                    class InfoProcJud:
                        """
                        :ivar tpProc:
                        :ivar nrProc: Informar um número de processo
                            cadastrado através do evento S-1070, cujo
                            {indMatProc}(1070_infoProcesso_inclusao_dadosProc_indMatProc)
                            seja igual a [1]. Validação: Deve ser um
                            número de processo administrativo ou
                            judicial válido e existente na Tabela de
                            Processos (S-1070), com
                            {indMatProc}(1070_infoProcesso_inclusao_dadosProc_indMatProc)
                            = [1].
                        :ivar codSusp:
                        :ivar vrCPSusp: Valor da contribuição
                            previdenciária com exigibilidade suspensa.
                            Validação: Preenchimento obrigatório se
                            {vrRatSusp}(./vrRatSusp) e
                            {vrSenarSusp}(./vrSenarSusp) não tiverem
                            sido preenchidos. Deve ser um valor maior
                            que 0 (zero).
                        :ivar vrRatSusp: Valor da contribuição para
                        ...
                        :ivar vrSenarSusp: Valor da contribuição para o
                            SENAR com exigibilidade suspensa. Validação:
                            Preenchimento obrigatório se
                            {vrCPSusp}(./vrCPSusp) e
                            {vrRatSusp}(./vrRatSusp) não tiverem sido
                            preenchidos. Deve ser um valor maior que 0
                            (zero).
                        """
