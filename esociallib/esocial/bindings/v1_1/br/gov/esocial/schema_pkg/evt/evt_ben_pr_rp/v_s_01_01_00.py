...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtBenPrRP/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
@dataclass
class TIdeEstab:
    """Identificação da unidade do órgão público DESCRICAO_COMPLETA:Identificação
    da unidade do órgão público na qual o beneficiário possui provento ou pensão.

    CHAVE_GRUPO: {tpInsc}, {nrInsc}

    :ivar tpInsc:
    :ivar nrInsc: Informar o número de inscrição da unidade do órgão
        público.
    :ivar itensRemun: Itens que compõem o provento ou pensão do
        beneficiário DESCRICAO_COMPLETA:Rubricas que compõem o provento
...
class ESocial:
    ...
    :ivar evtBenPrRP: Evento Benefícios - Entes Públicos. CHAVE_GRUPO:
        {Id} REGRA:REGRA_CONTROLE_DUPLICIDADE
    ...
    evtBenPrRP: Optional["ESocial.EvtBenPrRp"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtBenPrRp:
        ...
        :ivar ideEvento:
        :ivar ideEmpregador:
        :ivar ideBenef: Identificação do beneficiário. CHAVE_GRUPO:
            {cpfBenef*}
        :ivar dmDev: Demonstrativo de valores devidos ao beneficiário
        ...
        ideBenef: Optional["ESocial.EvtBenPrRp.IdeBenef"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class DmDev:
            ...
            :ivar ideDmDev: Identificador atribuído pelo órgão público
                para o demonstrativo de valores devidos ao beneficiário.
                O ente público pode preencher este campo utilizando-se
                de um identificador padrão para todos os beneficiários;
                ...
                único dentro do mesmo {perApur}(1207_ideEvento_perApur)
                para cada um dos demonstrativos do beneficiário.
            ...
            :ivar infoPerApur: Informações relativas ao período de
                ...
                {infoPerAnt}(1207_dmDev_infoPerAnt)); OC (nos demais
                casos)
            :ivar infoPerAnt: Informações relativas a períodos
                anteriores DESCRICAO_COMPLETA:Grupo destinado às
                informações relativas a períodos anteriores. Somente
                preencher esse grupo se houver proventos ou pensões
                retroativos. CONDICAO_GRUPO: O (se não existir o grupo
                {infoPerApur}(1207_dmDev_infoPerApur) e
                {indApuracao}(1207_ideEvento_indApuracao) = [1]); N (se
                {indApuracao}(1207_ideEvento_indApuracao) = [2]); OC
                (nos demais casos)
            """
            ...
            infoPerApur: Optional["ESocial.EvtBenPrRp.DmDev.InfoPerApur"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            infoPerAnt: Optional["ESocial.EvtBenPrRp.DmDev.InfoPerAnt"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            ...
            class InfoPerAnt:
                ...
                :ivar idePeriodo: Identificação do período de referência
                    ...
                    se referem as diferenças de provento ou pensão.
                    CHAVE_GRUPO: {perRef}
                """
                ...
                class IdePeriodo:
                    ...
                    :ivar perRef: Informar o período ao qual se refere o
                        complemento de provento ou pensão, no formato
                        AAAA-MM. Validação: Deve ser igual ou anterior
                        ao período de apuração informado em
                        {perApur}(1207_ideEvento_perApur). Deve ser
