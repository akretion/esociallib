...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtTSVAltContr/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ESocial:
    ...
    :ivar evtTSVAltContr: Evento TSVE - Alteração Contratual
        DESCRICAO_COMPLETA:Evento Trabalhador Sem Vínculo de
        Emprego/Estatutário - Alteração Contratual. CHAVE_GRUPO: {Id}
    ...
    evtTSVAltContr: Optional["ESocial.EvtTsvaltContr"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtTsvaltContr:
        ...
        :ivar infoTSVAlteracao: TSVE - Alteração Contratual.
        ...
        infoTSVAlteracao: Optional["ESocial.EvtTsvaltContr.InfoTsvalteracao"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class InfoTsvalteracao:
            ...
            :ivar natAtividade: Natureza da atividade. Validação:
                Preenchimento obrigatório se o código de categoria no
                Registro de Eventos Trabalhistas - RET for igual a [201,
                202, 401, 731, 734, 738]. Não deve ser preenchido se o
                código de categoria no RET for igual a [721, 722, 771,
                901].
            ...
            """
            dtAlteracao: Optional[XmlDate] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            infoComplementares: Optional["ESocial.EvtTsvaltContr.InfoTsvalteracao.InfoComplementares"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            ...
            class InfoComplementares:
                ...
                :ivar cargoFuncao: Cargo/Função ocupado pelo TSVE
                    ...
                    função ocupada pelo TSVE. CONDICAO_GRUPO: OC (se o
                    código de categoria no RET for igual a [901, 903,
                    904, 906]); O (nos demais casos)
                :ivar remuneracao: Informações da remuneração e
                    periodicidade de pagamento. CONDICAO_GRUPO: O (se o
                    código de categoria no RET for igual a [721, 722,
                    771, 906]); OC (nos demais casos)
                :ivar infoDirigenteSindical: Informações relativas ao
                    dirigente sindical. CONDICAO_GRUPO: O (se o código
                    de categoria no RET for igual a [401]); N (nos
                    demais casos)
                :ivar infoTrabCedido: Informações relativas ao
                    ...
                    trabalhador cedido/em exercício em outro órgão,
                    preenchidas exclusivamente pelo cessionário/órgão de
                    destino. CONDICAO_GRUPO: O (se o código de categoria
                    no RET for igual a [410]); N (nos demais casos)
                :ivar infoMandElet: Informações relativas a servidor
                    ...
                    for igual a [304]); N (nos demais casos)
                ...
                """
                cargoFuncao: Optional["ESocial.EvtTsvaltContr.InfoTsvalteracao.InfoComplementares.CargoFuncao"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                ...
                infoDirigenteSindical: Optional["ESocial.EvtTsvaltContr.InfoTsvalteracao.InfoComplementares.InfoDirigenteSindical"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                )
                infoTrabCedido: Optional["ESocial.EvtTsvaltContr.InfoTsvalteracao.InfoComplementares.InfoTrabCedido"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                )
                infoMandElet: Optional["ESocial.EvtTsvaltContr.InfoTsvalteracao.InfoComplementares.InfoMandElet"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                ...
                class CargoFuncao:
                    ...
                    :ivar nmCargo: Informar o nome do cargo. Validação:
                        Preenchimento obrigatório se o código de
                    ...
                    :ivar nmFuncao: Informar o nome da função de
                        ...
                        se o código de categoria no RET for igual a
                ...
                class InfoDirigenteSindical:
                    ...
                    :ivar tpRegPrev: Tipo de regime previdenciário (ou
                        ...
                        do evento S-2300 for relativa a "Empregado", não
