...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtCdBenTerm/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ESocial:
    ...
    :ivar evtCdBenTerm: Evento Cadastro de Benefício - Término
        DESCRICAO_COMPLETA:Evento Cadastro de Benefício - Entes Públicos
        - Término. CHAVE_GRUPO: {Id}
    ...
    evtCdBenTerm: Optional["ESocial.EvtCdBenTerm"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtCdBenTerm:
        ...
        infoBenTermino: Optional["ESocial.EvtCdBenTerm.InfoBenTermino"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class InfoBenTermino:
            ...
            :ivar dtTermBeneficio: Data de cessação do benefício.
                ...
                {dtEfetReativ}(2418_infoReativ_dtEfetReativ) do evento
                S-2418.
            :ivar mtvTermino:
            :ivar cnpjOrgaoSuc: Informar o CNPJ do órgão público
                sucessor. Validação: Preenchimento obrigatório e
                exclusivo se {mtvTermino}(./mtvTermino) = [09]. Deve ser
                um CNPJ válido e diferente da inscrição do declarante,
                considerando as particularidades aplicadas à informação
                de CNPJ de órgão público em S-1000. Além disso, deve
                possuir 14 (catorze) algarismos e ser diferente do CNPJ
                base do órgão público declarante (exceto se
                {ideEmpregador/nrInsc}(2420_ideEmpregador_nrInsc) tiver
                14 (catorze) algarismos) e dos estabelecimentos
                informados através do evento S-1005.
            :ivar novoCPF: Preencher com o novo CPF do beneficiário.
                Validação: Preenchimento obrigatório e exclusivo se
                {mtvTermino}(./mtvTermino) = [10]. Deve ser um CPF
                válido e diferente do antigo CPF do beneficiário.
            """
            ...
            cnpjOrgaoSuc: Optional[str] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "pattern": r"\d{14}",
