...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtExclusao/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ESocial:
    ...
    :ivar evtExclusao: Evento Exclusão DESCRICAO_COMPLETA:Evento
    ...
    evtExclusao: Optional["ESocial.EvtExclusao"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtExclusao:
        ...
        :ivar Id:
        """
        ideEvento: Optional[TIdeEventoExclusao] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        infoExclusao: Optional["ESocial.EvtExclusao.InfoExclusao"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class InfoExclusao:
            ...
            :ivar ideTrabalhador: Identificação do trabalhador a que se
                ...
                casos)
            :ivar ideFolhaPagto: Identificação do período de apuração a
                que se refere o evento que será excluído
            ...
            ideTrabalhador: Optional["ESocial.EvtExclusao.InfoExclusao.IdeTrabalhador"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            ideFolhaPagto: Optional["ESocial.EvtExclusao.InfoExclusao.IdeFolhaPagto"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            ...
            class IdeFolhaPagto:
                ...
                :ivar indApuracao: Indicativo de período de apuração.
                    ...
                    S-1280, S-1300].
                :ivar perApur: Informar o mês/ano (formato AAAA-MM) ou
