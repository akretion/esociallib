...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtAltCadastral/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ESocial:
    ...
    :ivar evtAltCadastral: Evento Alteração de Dados Cadastrais do
        Trabalhador. CHAVE_GRUPO: {Id} REGRA:REGRA_ENVIO_PROC_FECHAMENTO
        REGRA:REGRA_EVENTOS_EXTEMP
        REGRA:REGRA_EVENTO_POSTERIOR_CAT_OBITO
        REGRA:REGRA_EXISTE_INFO_EMPREGADOR
        REGRA:REGRA_EXISTE_TRABALHADOR REGRA:REGRA_EXTEMP_DOMESTICO
    ...
    evtAltCadastral: Optional["ESocial.EvtAltCadastral"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtAltCadastral:
        ...
        :ivar ideTrabalhador: Identificação do trabalhador. CHAVE_GRUPO:
            {cpfTrab*}
        :ivar alteracao: Alteração de dados cadastrais do trabalhador.
        ...
        ideTrabalhador: Optional["ESocial.EvtAltCadastral.IdeTrabalhador"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        alteracao: Optional["ESocial.EvtAltCadastral.Alteracao"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class Alteracao:
            ...
            dadosTrabalhador: Optional["ESocial.EvtAltCadastral.Alteracao.DadosTrabalhador"] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            class DadosTrabalhador:
                ...
                :ivar endereco: Endereço do trabalhador
                    DESCRICAO_COMPLETA:Grupo de informações do endereço
                    do trabalhador.
                :ivar trabImig: Informações do trabalhador imigrante.
                    CONDICAO_GRUPO: OC (se
                    {paisNac}(2205_alteracao_dadosTrabalhador_paisNac)
                    for diferente de [105]); N (nos demais casos)
                :ivar infoDeficiencia: Pessoa com deficiência.
                    CONDICAO_GRUPO: OC
                :ivar dependente: Informações dos dependentes.
                    CHAVE_GRUPO: {tpDep}, {nmDep}, {dtNascto}
                    CONDICAO_GRUPO: OC
                :ivar contato: Informações de contato. CONDICAO_GRUPO:
                    OC
                """
                ...
                endereco: Optional["ESocial.EvtAltCadastral.Alteracao.DadosTrabalhador.Endereco"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
                ...
                trabImig: Optional["ESocial.EvtAltCadastral.Alteracao.DadosTrabalhador.TrabImig"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                )
                infoDeficiencia: Optional["ESocial.EvtAltCadastral.Alteracao.DadosTrabalhador.InfoDeficiencia"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                ...
                class InfoDeficiencia:
                    ...
                    :ivar infoCota: Informar se o trabalhador deve ser
                        contabilizado no preenchimento de cota de
                        pessoas com deficiência habilitadas ou de
                        beneficiários reabilitados. Validação:
                        Preenchimento obrigatório e exclusivo quando
                        houver trabalhador cadastrado no evento S-2200
                        com {tpRegTrab}(2200_vinculo_tpRegTrab) = [1] e
                        ativo em
                        {dtAlteracao}(2205_alteracao_dtAlteracao).
                        Somente pode ser informado [S] se pelo menos um
                        ...
                        {reabReadap}(./reabReadap). Esta validação não
                        deve ser realizada quando se tratar de evento
                        enviado em versão do leiaute anterior a S-1.0.
                    :ivar observacao:
                    """
                ...
                class Dependente:
                    ...
                    :ivar sexoDep: Sexo do dependente. Validação:
                        ...
                        houver trabalhador cadastrado no evento S-2200,
                        ativo em
                        {dtAlteracao}(2205_alteracao_dtAlteracao) e com
                        {tpRegPrev} = [2] no RET. Esta validação não
                        deve ser realizada quando se tratar de recepção
                        de evento extemporâneo.
                    :ivar depIRRF:
                    :ivar depSF:
                    :ivar incTrab:
                    """
