...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtInfoComplPer/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ESocial:
    ...
    :ivar evtInfoComplPer: Evento Informações Complementares
        DESCRICAO_COMPLETA:Evento Informações Complementares aos Eventos
        Periódicos. CHAVE_GRUPO: {Id} REGRA:REGRA_ENVIO_PROC_FECHAMENTO
    ...
    evtInfoComplPer: Optional["ESocial.EvtInfoComplPer"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    @dataclass
    class EvtInfoComplPer:
        """
        :ivar ideEvento:
        :ivar ideEmpregador:
        :ivar infoSubstPatr: Inf. complementares - Empresas enquadradas
            nos arts. 7º a 9º da Lei 12.546/2011
            DESCRICAO_COMPLETA:Grupo preenchido exclusivamente por
            empresa enquadrada nos arts. 7º a 9º da Lei 12.546/2011,
            conforme classificação tributária indicada no evento S-1000.
            CONDICAO_GRUPO: O (se
            {indDesFolha}(1000_infoEmpregador_inclusao_infoCadastro_indDesFolha)
            em S-1000 = [1]); N (nos demais casos)
        :ivar infoSubstPatrOpPort: Informação de substituição prevista
            na Lei 12.546/2011 DESCRICAO_COMPLETA:Grupo preenchido
            exclusivamente pelo Órgão Gestor de Mão de Obra - OGMO
            ({classTrib}(1000_infoEmpregador_inclusao_infoCadastro_classTrib)
            em S-1000 = [09]), listando apenas seus códigos de lotação
            com operadores portuários enquadrados nos arts. 7º a 9º da
            Lei 12.546/2011. CHAVE_GRUPO: {codLotacao} CONDICAO_GRUPO:
            OC (se
            {classTrib}(1000_infoEmpregador_inclusao_infoCadastro_classTrib)
            em S-1000 = [09]; N (nos demais casos)
        :ivar infoAtivConcom: Empresas enquadradas no Simples Nacional -
            Atividades concomitantes DESCRICAO_COMPLETA:Grupo preenchido
            por empresa enquadrada no regime de tributação Simples
            Nacional com tributação previdenciária substituída e não
            substituída. CONDICAO_GRUPO: O (se
            {classTrib}(1000_infoEmpregador_inclusao_infoCadastro_classTrib)
            em S-1000 = [03]); N (nos demais casos)
        :ivar infoPercTransf11096: Transformação de entidade beneficente
            em empresa de fins lucrativos DESCRICAO_COMPLETA:Grupo
            preenchido por entidade que tenha se transformado em
            sociedade de fins lucrativos nos termos e no prazo da Lei
            11.096/2005. CONDICAO_GRUPO: O (se
            {dtTrans11096}(1000_infoEmpregador_inclusao_infoCadastro_dtTrans11096)
            em S-1000 for informado); N (nos demais casos)
        :ivar Id:
        """
        ideEvento: Optional[TIdeEventoFolha] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        infoSubstPatr: Optional["ESocial.EvtInfoComplPer.InfoSubstPatr"] = field(
            default=None,
            metadata={
                "type": "Element",
            }
        ...
        infoAtivConcom: Optional["ESocial.EvtInfoComplPer.InfoAtivConcom"] = field(
            default=None,
            metadata={
                "type": "Element",
            }
        )
        infoPercTransf11096: Optional["ESocial.EvtInfoComplPer.InfoPercTransf11096"] = field(
            default=None,
            metadata={
                "type": "Element",
            }
        ...
        class InfoSubstPatr:
            ...
            :ivar percRedContrib: Percentual não substituído pela
                contribuição prevista na Lei 12.546/2011. Informar 0
                (zero) se {indSubstPatr}(./indSubstPatr) = [1]. Caso
                contrário, preencher com o percentual correspondente à
                razão entre a receita de atividades não relacionadas nos
                arts. 7º e 8º da Lei 12.546/2011 e a receita bruta
                total. Validação: Se {indSubstPatr}(./indSubstPatr) =
                [1], informar 0 (zero).
            """
        ...
        class InfoSubstPatrOpPort:
            ...
            :ivar codLotacao: Informar o código atribuído pelo
                empregador para a lotação tributária. Validação: Deve
                ser um código válido e existente na Tabela de Lotações
                Tributárias (S-1020), com
        ...
        @dataclass
        class InfoAtivConcom:
            """
            :ivar fatorMes: Informe o fator a ser utilizado para cálculo
                da contribuição patronal do mês dos trabalhadores
                envolvidos na execução das atividades enquadradas no
                Anexo IV em conjunto com as dos Anexos I a III e V da
                Lei Complementar 123/2006.
            :ivar fator13: Informe o fator a ser utilizado para cálculo
                da contribuição patronal do décimo terceiro dos
                trabalhadores envolvidos na execução das atividades
                enquadradas no Anexo IV em conjunto com as dos Anexos I
        ...
        @dataclass
        class InfoPercTransf11096:
            """
            :ivar percTransf: Informe o percentual de contribuição
                social devida em caso de transformação em sociedade de
