...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtMonit/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ExMedOcupTpExameOcup(Enum):
    ...
    :cvar VALUE_1: Exame médico periódico, conforme Norma
        Regulamentadora 07 - NR-07 e/ou planejamento do Programa de
        Controle Médico de Saúde Ocupacional - PCMSO
    :cvar VALUE_2: Exame médico de retorno ao trabalho
    :cvar VALUE_3: Exame médico de mudança de função ou de mudança de
        risco ocupacional
    :cvar VALUE_4: Exame médico de monitoração pontual, não enquadrado
        nos demais casos
...
class ESocial:
    ...
    :ivar evtMonit: Evento Monitoramento da Saúde do Trabalhador.
        ...
        REGRA:REGRA_EXISTE_INFO_EMPREGADOR REGRA:REGRA_EXISTE_VINCULO
        REGRA:REGRA_EXTEMP_REINTEGRACAO REGRA:REGRA_MESMO_PROCEMI
    ...
    evtMonit: Optional["ESocial.EvtMonit"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtMonit:
        ...
        :ivar ideEmpregador:
        :ivar ideVinculo:
        :ivar exMedOcup: Informações do exame médico ocupacional.
        ...
        exMedOcup: Optional["ESocial.EvtMonit.ExMedOcup"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class ExMedOcup:
            """
            :ivar tpExameOcup:
            :ivar aso: ASO DESCRICAO_COMPLETA:Detalhamento das
                informações do Atestado de Saúde Ocupacional - ASO.
                CHAVE_GRUPO: {dtAso*}
            :ivar respMonit: Informações sobre o médico
                responsável/coordenador do PCMSO. CONDICAO_GRUPO: OC
            """
            tpExameOcup: Optional[ExMedOcupTpExameOcup] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            aso: Optional["ESocial.EvtMonit.ExMedOcup.Aso"] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            respMonit: Optional["ESocial.EvtMonit.ExMedOcup.RespMonit"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            ...
            class Aso:
                """
                :ivar dtAso: Data de emissão do ASO. Validação: Deve ser
                    uma data válida, igual ou anterior à data atual e
                    igual ou posterior à data de início da
                    obrigatoriedade deste evento para o empregador no
                    eSocial. Se {tpExameOcup}(../tpExameOcup) for
                    diferente de [0], também deve ser igual ou posterior
                    à data de admissão/exercício ou de início.
                :ivar resAso:
                :ivar exame: Avaliações clínicas e exames complementares
                    realizados DESCRICAO_COMPLETA:Grupo que detalha as
                    avaliações clínicas e os exames complementares
                    porventura realizados pelo trabalhador em virtude do
                    determinado nos Anexos da NR-07, além de outros
                    solicitados pelo médico e os referentes ao ASO.
                    CHAVE_GRUPO: {dtExm}, {procRealizado}
                :ivar medico: Informações sobre o médico emitente do
                    ASO.
                """
                dtAso: Optional[XmlDate] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
                ...
                resAso: Optional[AsoResAso] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                ...
                medico: Optional["ESocial.EvtMonit.ExMedOcup.Aso.Medico"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
                ...
                class Exame:
                    """
                    :ivar dtExm: Data do exame realizado. Validação:
                        Deve ser uma data válida, igual ou anterior à
                        data do ASO informada em {dtAso}(../dtAso).
                    :ivar procRealizado:
                    :ivar obsProc: Observação sobre o procedimento
                        diagnóstico realizado. Validação: Preenchimento
                        obrigatório se {procRealizado}(./procRealizado)
                        = [0583, 0998, 0999, 1128, 1230, 1992, 1993,
                        1994, 1995, 1996, 1997, 1998, 1999, 9999].
                    :ivar ordExame:
                    :ivar indResult:
                    """
                    dtExm: Optional[XmlDate] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                            "required": True,
                    ...
                    procRealizado: Optional[str] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                            "required": True,
                    ...
                    ordExame: Optional[ExameOrdExame] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                        }
                    )
                    indResult: Optional[ExameIndResult] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                        }
                ...
                class Medico:
                    """
                    :ivar nmMed: Preencher com o nome do médico emitente
                        do ASO.
                    :ivar nrCRM: Número de inscrição do médico emitente
                        do ASO no Conselho Regional de Medicina - CRM.
                    :ivar ufCRM: Preencher com a sigla da Unidade da
                        Federação - UF de expedição do CRM.
                    """
                    nmMed: Optional[str] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                            "required": True,
            ...
            class RespMonit:
                """
                :ivar cpfResp: Preencher com o CPF do médico
                    responsável/coordenador do PCMSO. Validação: Se
                    informado, deve ser um CPF válido.
                :ivar nmResp: Preencher com o nome do médico
                    responsável/coordenador do PCMSO.
                :ivar nrCRM: Número de inscrição do médico
                    responsável/coordenador do PCMSO no CRM.
                :ivar ufCRM: Preencher com a sigla da UF de expedição do
                    CRM.
                """
