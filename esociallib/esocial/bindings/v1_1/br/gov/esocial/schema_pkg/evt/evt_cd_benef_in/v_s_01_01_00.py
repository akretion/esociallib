...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtCdBenefIn/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ESocial:
    ...
    :ivar evtCdBenefIn: Evento Cadastro de Beneficiário - Início
        DESCRICAO_COMPLETA:Evento Cadastro de Beneficiário - Entes
        Públicos - Início. CHAVE_GRUPO: {Id}
        REGRA:REGRA_ENVIO_PROC_FECHAMENTO REGRA:REGRA_EVENTOS_EXTEMP
        REGRA:REGRA_EVENTO_EXT_SEM_IMPACTO_FOPAG
        REGRA:REGRA_EXISTE_INFO_EMPREGADOR REGRA:REGRA_VALIDA_CNPJ
    ...
    evtCdBenefIn: Optional["ESocial.EvtCdBenefIn"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtCdBenefIn:
        ...
        :ivar ideEmpregador: Informações de identificação do empregador.
            CHAVE_GRUPO: {tpInsc*}, {nrInsc*}
        :ivar beneficiario: Grupo de informações do beneficiário.
        ...
        ideEmpregador: Optional["ESocial.EvtCdBenefIn.IdeEmpregador"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        beneficiario: Optional["ESocial.EvtCdBenefIn.Beneficiario"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class Beneficiario:
            ...
            :ivar cpfBenef: Informar o CPF do beneficiário. Validação:
                Não é possível existir dois eventos originais do mesmo
                órgão público declarante para o mesmo CPF do
                beneficiário.
            :ivar nmBenefic:
            :ivar dtNascto: Preencher com a data de nascimento.
            :ivar dtInicio: Preencher com a data de início do cadastro
                do beneficiário. Informar a data de início da
                obrigatoriedade dos eventos não periódicos para o ente
                público no eSocial caso o beneficiário possua cadastro
                anterior a essa data. Validação: Deve ser igual ou
                posterior à data de início da obrigatoriedade dos
                eventos não periódicos para o ente público no eSocial e
                igual ou anterior à data atual.
            :ivar sexo: Sexo do beneficiário. Validação: Informação
                obrigatória se {dtInicio}(./dtInicio) for posterior ao
                início da obrigatoriedade dos eventos não periódicos
                para o ente público no eSocial.
            :ivar racaCor:
            :ivar estCiv:
            :ivar incFisMen:
            :ivar dtIncFisMen: Preencher com a data do reconhecimento da
                incapacidade. Validação: Informação obrigatória e
                exclusiva se {incFisMen}(./incFisMen) = [S].
            :ivar endereco: Endereço do beneficiário.
            ...
            incFisMen: Optional[TsSimNao] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            dtIncFisMen: Optional[XmlDate] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            endereco: Optional["ESocial.EvtCdBenefIn.Beneficiario.Endereco"] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            class Dependente:
                ...
                :ivar dtNascto:
                :ivar cpfDep:
                :ivar sexoDep: Sexo do dependente. Validação: Informação
                    obrigatória se {dtInicio}(../dtInicio) for posterior
                    ao início da obrigatoriedade dos eventos não
