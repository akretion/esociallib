...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtCdBenefAlt/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ESocial:
    ...
    :ivar evtCdBenefAlt: Evento Cadastro de Beneficiário - Alteração
        DESCRICAO_COMPLETA:Evento Cadastro de Beneficiário - Entes
        Públicos - Alteração. CHAVE_GRUPO: {Id}
    ...
    evtCdBenefAlt: Optional["ESocial.EvtCdBenefAlt"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtCdBenefAlt:
        ...
        :ivar ideBenef: Identificação do beneficiário. CHAVE_GRUPO:
            {cpfBenef*}
        :ivar alteracao: Alteração de dados do beneficiário.
        ...
        ideBenef: Optional["ESocial.EvtCdBenefAlt.IdeBenef"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        alteracao: Optional["ESocial.EvtCdBenefAlt.Alteracao"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class IdeBenef:
            ...
            :ivar cpfBenef: Informar o CPF do beneficiário. Validação:
                Deve ser um CPF válido e cadastrado pelo órgão público
                declarante por meio do evento S-2400.
            """
            cpfBenef: Optional[str] = field(
                default=None,
                metadata={
        ...
        class Alteracao:
            """
            :ivar dtAlteracao: Preencher com a data de alteração.
                Validação: Deve ser posterior à data de início informada
                no evento S-2400 e igual ou anterior à data atual.
            ...
            dadosBenef: Optional["ESocial.EvtCdBenefAlt.Alteracao.DadosBenef"] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            class DadosBenef:
                ...
                endereco: Optional["ESocial.EvtCdBenefAlt.Alteracao.DadosBenef.Endereco"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
