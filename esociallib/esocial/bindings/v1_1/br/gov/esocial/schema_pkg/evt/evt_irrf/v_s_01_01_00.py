...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtIrrf/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class InfoIrrfIndExistInfo(Enum):
    ...
    :cvar VALUE_3: Não há movimento no período informado em
        {perApur}(5012_ideEvento_perApur)
    """
    VALUE_1 = 1
    VALUE_2 = 2
    VALUE_3 = 3
...
class ESocial:
    ...
    :ivar evtIrrf: Evento IRRF Consolidado por Contribuinte.
        DESCRICAO_COMPLETA:Evento Imposto de Renda Retido na Fonte
        Consolidado por Contribuinte. CHAVE_GRUPO: {Id}
    :ivar signature:
    """
    class Meta:
        name = "eSocial"
    ...
    evtIrrf: Optional["ESocial.EvtIrrf"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtIrrf:
        ...
        :ivar Id:
        """
        ideEvento: Optional[TIdeEventoRetornoMensal] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        infoIRRF: Optional["ESocial.EvtIrrf.InfoIrrf"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class InfoIrrf:
            ...
            :ivar nrRecArqBase:
            :ivar indExistInfo:
            :ivar infoCRMen: Totalizador do IRRF por CR mensal.
                DESCRICAO_COMPLETA:Informações consolidadas do IRRF, por
                Código de Receita - CR mensal. Evento de origem: S-5002.
                CHAVE_GRUPO: {CRMen} CONDICAO_GRUPO: OC
            :ivar infoCRDia: Totalizador do IRRF por CR diário.
                DESCRICAO_COMPLETA:Informações consolidadas do IRRF, por
                Código de Receita - CR diário. Evento de origem: S-5002.
                CHAVE_GRUPO: {perApurDia}, {CRDia} CONDICAO_GRUPO: OC
            """
            nrRecArqBase: Optional[str] = field(
                default=None,
                metadata={
            ...
            indExistInfo: Optional[InfoIrrfIndExistInfo] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            class InfoCrmen:
                """
                :ivar CRMen:
                :ivar vrCRMen: Valor correspondente ao Código de Receita
                    - CR indicado em {CRMen}(./CRMen).
                :ivar vrCRMenSusp: Valor com exigibilidade suspensa
                    correspondente ao Código de Receita - CR indicado em
                    {CRMen}(./CRMen).
                """
                ...
                vrCRMen: Optional[Decimal] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
                ...
                vrCRMenSusp: Optional[Decimal] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "min_inclusive": Decimal("0"),
            ...
            class InfoCrdia:
                """
                :ivar perApurDia: Período de apuração diário do Código
                    de Receita - CR.
                :ivar CRDia:
                :ivar vrCRDia: Valor relativo ao Imposto de Renda Retido
                    na Fonte sobre rendimentos do trabalho pagos a
                    residente, para fins fiscais, no exterior.
                :ivar vrCRDiaSusp: Valor que deixou de ser descontado do
                    trabalhador relativo ao Imposto de Renda sobre
                    rendimentos do trabalho pagos a residente, para fins
                    fiscais, no exterior.
                """
                ...
                vrCRDia: Optional[Decimal] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
                ...
                vrCRDiaSusp: Optional[Decimal] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "min_inclusive": Decimal("0"),
