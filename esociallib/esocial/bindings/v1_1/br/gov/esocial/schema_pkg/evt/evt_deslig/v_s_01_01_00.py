...
class TsPensAlim(Enum):
    """
    :cvar VALUE_0: Não existe pensão alimentícia
    :cvar VALUE_1: Percentual de pensão alimentícia
    :cvar VALUE_2: Valor de pensão alimentícia
    :cvar VALUE_3: Percentual e valor de pensão alimentícia
    """
    VALUE_0 = 0
    VALUE_1 = 1
    VALUE_2 = 2
...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtDeslig/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class IdeAdcTpAcConv(Enum):
    ...
    Validação: Se {classTrib}(1000_infoEmpregador_inclusao_infoCadastro_classTrib) em S-1000 = [04, 22], não pode ser informado [E, H].
...
class RemunAposDesligIndRemun(Enum):
    ...
    :cvar VALUE_2: Desligamento reconhecido judicialmente com data
        anterior a competências com remunerações já informadas no
        eSocial
    :cvar VALUE_3: Aposentadoria de servidor com data anterior a
...
class TIdeEstabLot:
    ...
    :ivar nrInsc:
    :ivar codLotacao:
    :ivar detVerbas: Detalhamento das verbas rescisórias
        DESCRICAO_COMPLETA:Detalhamento das verbas rescisórias devidas
        ao trabalhador. Deve haver pelo menos uma rubrica de folha,
        mesmo que o valor líquido a ser pago ao trabalhador seja 0
        (zero) em função de descontos.
    :ivar infoAgNocivo: Grau de exposição a agentes nocivos
        DESCRICAO_COMPLETA:Grupo referente ao detalhamento do grau de
        exposição do trabalhador aos agentes nocivos que ensejam a
        cobrança da contribuição adicional para financiamento dos
        benefícios de aposentadoria especial. CONDICAO_GRUPO: O (se o
        trabalhador estiver amparado pelo RGPS); N (nos demais casos)
    :ivar infoSimples:
    """
    class Meta:
        name = "T_ideEstabLot"
    ...
    detVerbas: List["TIdeEstabLot.DetVerbas"] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtDeslig/v_S_01_01_00",
    ...
    infoAgNocivo: Optional["TIdeEstabLot.InfoAgNocivo"] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtDeslig/v_S_01_01_00",
    ...
    infoSimples: Optional[TInfoSimples] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtDeslig/v_S_01_01_00",
    ...
    class DetVerbas:
        """
        :ivar codRubr: Informar o código atribuído pelo empregador que
            identifica a rubrica em sua folha de pagamento ou o código
            da rubrica constante da Tabela de Rubricas Padrão.
        ...
        :ivar vrRubr:
        :ivar indApurIR: Indicativo de tipo de apuração de IR.
            Validação: Informação obrigatória e exclusiva se mês/ano de
            {dtDeslig}(2299_infoDeslig_dtDeslig) &gt;= [2021-07].
        """
        codRubr: Optional[str] = field(
            default=None,
...
class ESocial:
    ...
    :ivar evtDeslig: Evento Desligamento. CHAVE_GRUPO: {Id}
    ...
    evtDeslig: Optional["ESocial.EvtDeslig"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtDeslig:
        ...
        :ivar ideEmpregador:
        :ivar ideVinculo:
        :ivar infoDeslig: Informações relativas ao desligamento do
            vínculo. CHAVE_GRUPO: {dtDeslig*}
        :ivar Id:
        """
        ideEvento: Optional[TIdeEventoTrabIndGuia] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        ideVinculo: Optional[TIdeVinculo] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        infoDeslig: Optional["ESocial.EvtDeslig.InfoDeslig"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class InfoDeslig:
            ...
            :ivar dtDeslig: Preencher com a data de desligamento do
                vínculo (último dia trabalhado). Validação: Deve ser uma
                data igual ou anterior à data atual acrescida de 10
                (dez) dias. No caso de empregado reintegrado e quando
                não se tratar de retificação do desligamento anterior à
                reintegração, também deve ser uma data igual ou
                posterior a
                {dtEfetRetorno}(2298_infoReintegr_dtEfetRetorno) do
                evento S-2298.
            :ivar dtAvPrv: Data de concessão do aviso prévio. Validação:
                Se informada, deve ser igual ou posterior à data de
                admissão e igual ou anterior a {dtDeslig}(./dtDeslig).
            :ivar indPagtoAPI: Indicativo de pagamento de aviso prévio
                indenizado pelo empregador, ao empregado.
            :ivar dtProjFimAPI: Data projetada para o término do aviso
                prévio indenizado. Validação: Obrigatório se
                {indPagtoAPI}(./indPagtoAPI) for igual a [S], devendo
                ser igual ou posterior a {dtDeslig}(./dtDeslig).
            :ivar pensAlim: Indicativo de pensão alimentícia para fins
                de retenção de FGTS. Validação: Preenchimento
                obrigatório e exclusivo se o vínculo for celetista
                ({tpRegTrab}(2200_vinculo_tpRegTrab) em S-2200 = [1]).
            :ivar percAliment:
            :ivar vrAlim:
            :ivar nrProcTrab: Número que identifica o processo
                trabalhista, quando o desligamento se der por decisão
            ...
            :ivar infoInterm: Informações relativas ao trabalho
                intermitente. CHAVE_GRUPO: {dia} CONDICAO_GRUPO: O (se o
                código de categoria no RET for igual a [111] no mês/ano
                de {dtDeslig}(2299_infoDeslig_dtDeslig); N (nos demais
                casos)
            :ivar observacoes: Observações sobre o desligamento.
                CONDICAO_GRUPO: OC
            :ivar sucessaoVinc: Sucessão do vínculo
                trabalhista/estatutário DESCRICAO_COMPLETA:Grupo
                preenchido exclusivamente nos casos de sucessão do
                vínculo trabalhista, com a identificação da empresa
                sucessora. CONDICAO_GRUPO: O (se
                {mtvDeslig}(2299_infoDeslig_mtvDeslig) = [11, 12, 13,
                28, 29, 37, 43]); N (nos demais casos)
            :ivar transfTit: Transferência de titularidade do empregado
                doméstico DESCRICAO_COMPLETA:Transferência de
                titularidade do empregado doméstico para outro
                representante da mesma unidade familiar. CONDICAO_GRUPO:
                O (se {mtvDeslig}(2299_infoDeslig_mtvDeslig) = [34]); N
                (nos demais casos)
            :ivar mudancaCPF: Informação do novo CPF do trabalhador.
                CONDICAO_GRUPO: O (se
                {mtvDeslig}(2299_infoDeslig_mtvDeslig) = [36]); N (nos
                demais casos)
            :ivar verbasResc: Verbas rescisórias
                DESCRICAO_COMPLETA:Grupo onde são prestadas as
                informações relativas às verbas devidas ao trabalhador
                na rescisão contratual. CONDICAO_GRUPO: N (se
                {mtvDeslig}(2299_infoDeslig_mtvDeslig) = [11, 12, 13,
                25, 28, 29, 30, 34, 36, 43, 44] OU
                {dtDeslig}(2299_infoDeslig_dtDeslig) for anterior ao
                início de obrigatoriedade dos eventos periódicos para o
                empregador OU {tpRegTrab}(2200_vinculo_tpRegTrab) em
                S-2200 = [2]); OC (nos demais casos)
            :ivar remunAposDeslig: Informações sobre a quarentena
                remunerada ou outra situação de desligamento com data
                anterior DESCRICAO_COMPLETA:Informações sobre a
                "quarentena" remunerada de trabalhador desligado ou
                outra situação de desligamento com data anterior. O
                grupo deve ser preenchido apenas no caso do trabalhador
                que recebe remuneração após o desligamento por estar
                impossibilitado de exercer atividade remunerada, no caso
                de desligamento reconhecido judicialmente com data
                anterior a competências com remunerações já informadas
                ou em caso de concessão de aposentadoria de servidor com
                data anterior a competências com remunerações já
                informadas no eSocial. CONDICAO_GRUPO: OC
            :ivar consigFGTS: Informações sobre operação de crédito
                consignado com garantia de FGTS. CONDICAO_GRUPO: OC
            """
            ...
            dtAvPrv: Optional[XmlDate] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            indPagtoAPI: Optional[TsSimNao] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            pensAlim: Optional[TsPensAlim] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            percAliment: Optional[Decimal] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "min_exclusive": Decimal("0"),
            ...
            infoInterm: List[TInfoInterm] = field(
                default_factory=list,
                metadata={
                    "type": "Element",
                    "max_occurs": 31,
            ...
            sucessaoVinc: Optional["ESocial.EvtDeslig.InfoDeslig.SucessaoVinc"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            transfTit: Optional["ESocial.EvtDeslig.InfoDeslig.TransfTit"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            mudancaCPF: Optional["ESocial.EvtDeslig.InfoDeslig.MudancaCpf"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            verbasResc: Optional["ESocial.EvtDeslig.InfoDeslig.VerbasResc"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            remunAposDeslig: Optional["ESocial.EvtDeslig.InfoDeslig.RemunAposDeslig"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            ...
            class Observacoes:
                """
                :ivar observacao: Observação relevante sobre o
                    desligamento do trabalhador, que não esteja
            ...
            class SucessaoVinc:
                ...
                :ivar nrInsc: Informar o número de inscrição do
                    empregador sucessor, de acordo com o tipo de
                    inscrição indicado no campo
                    {sucessaoVinc/tpInsc}(./tpInsc). Validação: Deve ser
                    um número de inscrição válido e diferente da
                    inscrição do declarante, considerando as
                    particularidades aplicadas à informação de CNPJ de
                    órgão público em S-1000. Se
                    {sucessaoVinc/tpInsc}(./tpInsc) = [1], deve possuir
                    14 (catorze) algarismos e ser diferente do CNPJ base
                    do empregador (exceto se
                    {ideEmpregador/nrInsc}(2299_ideEmpregador_nrInsc)
                    tiver 14 (catorze) algarismos) e dos
                    estabelecimentos informados através do evento
                    S-1005. Se {sucessaoVinc/tpInsc}(./tpInsc) = [2],
            ...
            class TransfTit:
                """
                :ivar cpfSubstituto: Preencher com o CPF do novo
                    titular. Validação: Deve ser um CPF válido e
                    diferente do CPF do declarante e do empregado.
                :ivar dtNascto: Preencher com a data de nascimento do
                    novo titular. Validação: Deve corresponder à data de
                    nascimento cadastrada na base de dados do CPF do
                    {cpfSubstituto}(./cpfSubstituto).
                """
                cpfSubstituto: Optional[str] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
            ...
            class VerbasResc:
                """
                :ivar dmDev: Demonstrativo de valores devidos ao
                    trabalhador DESCRICAO_COMPLETA:Identificação de cada
                    um dos demonstrativos de valores devidos ao
                    trabalhador. CHAVE_GRUPO: {ideDmDev}
                    REGRA:REGRA_DEMONSTRATIVO
                :ivar procJudTrab:
                :ivar infoMV:
                :ivar procCS: Informação sobre processo judicial que
                    suspende a exigibilidade da Contribuição Social
                    Rescisória. CONDICAO_GRUPO: OC
                """
                ...
                procJudTrab: List[TProcJudTrab] = field(
                    default_factory=list,
                    metadata={
                        "type": "Element",
                        "max_occurs": 99,
                ...
                infoMV: Optional[TInfoMv] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                )
                procCS: Optional["ESocial.EvtDeslig.InfoDeslig.VerbasResc.ProcCs"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                ...
                class DmDev:
                    """
                    :ivar ideDmDev: Identificador atribuído pela empresa
                        ...
                        dentro da mesma competência (mês/ano da data de
                        desligamento) para cada um dos demonstrativos do
                        trabalhador. REGRA:REGRA_CARACTERE_ESPECIAL
                    :ivar indRRA: Indicativo de Rendimentos Recebidos
                        Acumuladamente - RRA. Somente preencher este
                        campo se for um demonstrativo de RRA.
                    :ivar infoRRA:
                    :ivar infoPerApur: Verbas rescisórias relativas ao
                        mês/ano da data do desligamento. CONDICAO_GRUPO:
                        O (se não existir o grupo
                        {infoPerAnt}(2299_infoDeslig_verbasResc_dmDev_infoPerAnt));
                        OC (nos demais casos)
                    :ivar infoPerAnt: Informações relativas a períodos
                        anteriores DESCRICAO_COMPLETA:Remuneração
                        relativa a períodos anteriores, devida em função
                        de acordos coletivos, legislação específica,
                        convenção coletiva de trabalho, dissídio ou
                        conversão de licença saúde em acidente de
                        trabalho. CONDICAO_GRUPO: O (se não existir o
                        grupo
                    ...
                    indRRA: Optional[TsIndRra] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                        }
                    )
                    infoRRA: Optional[TInfoRra] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                        }
                    )
                    infoPerApur: Optional["ESocial.EvtDeslig.InfoDeslig.VerbasResc.DmDev.InfoPerApur"] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                        }
                    )
                    infoPerAnt: Optional["ESocial.EvtDeslig.InfoDeslig.VerbasResc.DmDev.InfoPerAnt"] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                        }
                    ...
                    class InfoPerApur:
                        """
                        :ivar ideEstabLot: Identificação do
                            estabelecimento e lotação
                            DESCRICAO_COMPLETA:Identificação do
                            estabelecimento e da lotação nos quais o
                            trabalhador possui remuneração no período de
                            apuração. O estabelecimento identificado no
                            grupo pode ser: o número do CNPJ do
                            estabelecimento da própria empresa
                            (matriz/filial), o número da obra (própria)
                            no CNO, ou o número do CAEPF (no caso de
                            pessoa física obrigada a inscrição no
                            Cadastro de Atividade Econômica da Pessoa
                            Física). CHAVE_GRUPO: {tpInsc}, {nrInsc},
                            {codLotacao}
                        """
                    ...
                    class InfoPerAnt:
                        ...
                        :ivar ideADC: Instrumento ou situação ensejadora
                            ...
                            anteriores. CHAVE_GRUPO: {dtAcConv},
                            {tpAcConv}
                        """
                        ...
                        class IdeAdc:
                            ...
                            :ivar tpAcConv:
                            :ivar dsc:
                            :ivar idePeriodo: Identificação do período
                                de referência da remuneração
                                DESCRICAO_COMPLETA:Identificação do
                                período ao qual se referem as diferenças
                                de remuneração. CHAVE_GRUPO: {perRef}
                            """
                            ...
                            tpAcConv: Optional[IdeAdcTpAcConv] = field(
                                default=None,
                                metadata={
                                    "type": "Element",
                                    "required": True,
                            ...
                            idePeriodo: List["ESocial.EvtDeslig.InfoDeslig.VerbasResc.DmDev.InfoPerAnt.IdeAdc.IdePeriodo"] = field(
                                default_factory=list,
                                metadata={
                                    "type": "Element",
                                    "min_occurs": 1,
                            ...
                            class IdePeriodo:
                                ...
                                :ivar perRef: Informar o período ao qual
                                    se refere o complemento de
                                    remuneração, no formato AAAA-MM.
                                    Validação: Deve ser igual ou
                                    anterior ao mês/ano da data do
                                    desligamento, informada em
                                    {dtDeslig}(2299_infoDeslig_dtDeslig).
                                    Deve ser informado no formato AAAA-
                                    MM. Se {tpAcConv}(../tpAcConv) =
                                    [H], deve ser anterior ao início dos
                                    eventos periódicos para o empregador
                                    no eSocial.
                                :ivar ideEstabLot: Identificação do
                                    estabelecimento e lotação
                                    DESCRICAO_COMPLETA:Identificação do
                                    estabelecimento e da lotação aos
                                    quais se referem as diferenças de
                                    remuneração do mês identificado no
                                    grupo superior. CHAVE_GRUPO:
            ...
            @dataclass
            class RemunAposDeslig:
                """
                :ivar indRemun:
                :ivar dtFimRemun: Preencher com a data final da
                    quarentena a que está sujeito o trabalhador. No caso
                    de desligamento reconhecido judicialmente ou de
                    concessão de aposentadoria de servidor com data
                    anterior a competências com remunerações já
                    informadas no eSocial, informar o último dia
                    trabalhado. Validação: Deve ser uma data posterior a
                    {dtDeslig}(2299_infoDeslig_dtDeslig).
                """
                indRemun: Optional[RemunAposDesligIndRemun] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                )
                dtFimRemun: Optional[XmlDate] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
