...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtReativBen/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ESocial:
    ...
    :ivar evtReativBen: Evento Reativação de Benefício
        DESCRICAO_COMPLETA:Evento Reativação de Benefício - Entes
        Públicos. CHAVE_GRUPO: {Id} REGRA:REGRA_ENVIO_PROC_FECHAMENTO
    ...
    evtReativBen: Optional["ESocial.EvtReativBen"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtReativBen:
        ...
        :ivar ideEmpregador:
        :ivar ideBeneficio:
        :ivar infoReativ: Informações da reativação do benefício.
        ...
        infoReativ: Optional["ESocial.EvtReativBen.InfoReativ"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class InfoReativ:
            """
            :ivar dtEfetReativ: Informar a data da efetiva reativação do
                benefício. Validação: Deve ser posterior à data de
                cessação do benefício e igual ou anterior à data atual.
            :ivar dtEfeito: Data de início dos efeitos financeiros da
                reativação do benefício. Validação: Deve ser uma data
                igual ou anterior à data da efetiva reativação do
                benefício e posterior à data de sua cessação.
            """
            dtEfetReativ: Optional[XmlDate] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
