...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtBaixa/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ESocial:
    ...
    :ivar evtBaixa: Evento Baixa Judicial do Vínculo. CHAVE_GRUPO: {Id}
    ...
    evtBaixa: Optional["ESocial.EvtBaixa"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtBaixa:
        ...
        :ivar ideEmpregador:
        :ivar ideVinculo:
        :ivar infoBaixa: Informações relativas à baixa judicial do
            vínculo. CHAVE_GRUPO: {dtDeslig*}
        :ivar Id:
        """
        ideEvento: Optional[TIdeEventoTrabJud] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        ideVinculo: Optional[TIdeVinculoBaixa] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        infoBaixa: Optional["ESocial.EvtBaixa.InfoBaixa"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class InfoBaixa:
            ...
            :ivar dtDeslig: Preencher com a data de desligamento do
                ...
                data igual ou posterior a 24/09/2019 e igual ou anterior
                à data atual. No caso de empregado reintegrado e quando
            ...
            :ivar dtProjFimAPI: Data projetada para o término do aviso
                prévio indenizado. Validação: Se preenchida, deve ser
                uma data posterior a {dtDeslig}(./dtDeslig).
            :ivar nrProcTrab: Número que identifica o processo judicial
                onde a baixa do vínculo foi determinada. Validação: Deve
                ser um processo judicial válido, com 20 (vinte)
                algarismos.
            :ivar observacao: Observação relevante sobre o desligamento
                do trabalhador, que não esteja consignada em outros
                campos.
            """
