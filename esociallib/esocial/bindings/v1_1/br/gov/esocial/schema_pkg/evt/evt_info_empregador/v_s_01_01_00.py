...
class TInfoCadastro:
    ...
    :ivar classTrib:
    :ivar indCoop: Indicativo de cooperativa. Validação: O preenchimento
        do campo é exclusivo e obrigatório para PJ. Somente pode ser
        diferente de [0] se a natureza jurídica do declarante for igual
        a 214-3.
    :ivar indConstr: Indicativo de construtora. Validação: O
        preenchimento do campo é exclusivo e obrigatório para PJ.
    :ivar indDesFolha:
    :ivar indOpcCP:
    :ivar indPorte:
    :ivar indOptRegEletron:
    :ivar cnpjEFR: CNPJ do Ente Federativo Responsável - EFR. Validação:
        Preenchimento obrigatório e exclusivo se a natureza jurídica do
        declarante for Administração Pública (grupo [1]). Nesse caso,
        informar o campo com 14 (catorze) algarismos. Informação
        validada no cadastro do CNPJ da RFB.
    :ivar dtTrans11096: Data da transformação em sociedade de fins
        lucrativos - Lei 11.096/2005. Validação: Não preencher se
        {classTrib}(./classTrib) = [21, 22].
    :ivar indTribFolhaPisCofins:
    :ivar dadosIsencao: Informações complementares - Empresas isentas -
        Dados da isenção. CONDICAO_GRUPO: OC (se
        {classTrib}(1000_infoEmpregador_inclusao_infoCadastro_classTrib)
        = [80]); N (nos demais casos)
    :ivar infoOrgInternacional: Informações exclusivas de organismos
    ...
    indDesFolha: Optional[TInfoCadastroIndDesFolha] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtInfoEmpregador/v_S_01_01_00",
    ...
    indOpcCP: Optional[TInfoCadastroIndOpcCp] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtInfoEmpregador/v_S_01_01_00",
    ...
    indPorte: Optional[TInfoCadastroIndPorte] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtInfoEmpregador/v_S_01_01_00",
    ...
    indOptRegEletron: Optional[TInfoCadastroIndOptRegEletron] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtInfoEmpregador/v_S_01_01_00",
    ...
    dtTrans11096: Optional[XmlDate] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtInfoEmpregador/v_S_01_01_00",
    ...
    indTribFolhaPisCofins: Optional[TInfoCadastroIndTribFolhaPisCofins] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtInfoEmpregador/v_S_01_01_00",
    ...
    dadosIsencao: Optional["TInfoCadastro.DadosIsencao"] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtInfoEmpregador/v_S_01_01_00",
    ...
    infoOrgInternacional: Optional["TInfoCadastro.InfoOrgInternacional"] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtInfoEmpregador/v_S_01_01_00",
    ...
    class DadosIsencao:
        ...
        :ivar ideMinLei:
        :ivar nrCertif:
        :ivar dtEmisCertif: Data de emissão do certificado/publicação da
            lei.
        :ivar dtVencCertif: Data de vencimento do certificado.
            Validação: Não pode ser anterior a
            {dtEmisCertif}(./dtEmisCertif).
        :ivar nrProtRenov:
        :ivar dtProtRenov: Data do protocolo de renovação.
        :ivar dtDou: Data de publicação no Diário Oficial da União -
            DOU.
        :ivar pagDou:
        """
        ideMinLei: Optional[str] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.esocial.gov.br/schema/evt/evtInfoEmpregador/v_S_01_01_00",
        ...
        dtEmisCertif: Optional[XmlDate] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.esocial.gov.br/schema/evt/evtInfoEmpregador/v_S_01_01_00",
        ...
        dtVencCertif: Optional[XmlDate] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.esocial.gov.br/schema/evt/evtInfoEmpregador/v_S_01_01_00",
        ...
        nrProtRenov: Optional[str] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.esocial.gov.br/schema/evt/evtInfoEmpregador/v_S_01_01_00",
        ...
        dtProtRenov: Optional[XmlDate] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.esocial.gov.br/schema/evt/evtInfoEmpregador/v_S_01_01_00",
    ...
    class InfoOrgInternacional:
        indAcordoIsenMulta: Optional[InfoOrgInternacionalIndAcordoIsenMulta] = field(
            default=None,
            metadata={
                "type": "Element",
                "namespace": "http://www.esocial.gov.br/schema/evt/evtInfoEmpregador/v_S_01_01_00",
...
class ESocial:
    ...
    :ivar evtInfoEmpregador: Evento Informações do Empregador.
    ...
    evtInfoEmpregador: Optional["ESocial.EvtInfoEmpregador"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtInfoEmpregador:
        ...
        :ivar ideEmpregador: Informações de identificação do empregador.
            CHAVE_GRUPO: {tpInsc*}, {nrInsc*}
        :ivar infoEmpregador: Informações do empregador.
        ...
        ideEmpregador: Optional["ESocial.EvtInfoEmpregador.IdeEmpregador"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        infoEmpregador: Optional["ESocial.EvtInfoEmpregador.InfoEmpregador"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class IdeEmpregador:
            ...
            :ivar nrInsc: Informar o número de inscrição do contribuinte
                de acordo com o tipo de inscrição indicado no campo
                {tpInsc}(./tpInsc). Validação: Se {tpInsc}(./tpInsc) for
                igual a [1], deve ser um número de CNPJ válido. Neste
                caso, deve ser informada apenas a raiz/base (8
                posições), exceto se a natureza jurídica do declarante
                for igual a 101-5, 104-0, 107-4, 116-3 ou 134-1,
                situação em que o campo deve ser preenchido com o CNPJ
                completo (14 posições). Se {tpInsc}(./tpInsc) for igual
        ...
        class InfoEmpregador:
            ...
            """
            inclusao: Optional["ESocial.EvtInfoEmpregador.InfoEmpregador.Inclusao"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            alteracao: Optional["ESocial.EvtInfoEmpregador.InfoEmpregador.Alteracao"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            exclusao: Optional["ESocial.EvtInfoEmpregador.InfoEmpregador.Exclusao"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            ...
            @dataclass
            class Inclusao:
                idePeriodo: Optional[TIdePeriodo] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
                ...
                infoCadastro: Optional[TInfoCadastro] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
            ...
            class Alteracao:
                ...
                :ivar idePeriodo:
                :ivar infoCadastro:
                :ivar novaValidade: Novo período de validade das
                ...
                novaValidade: Optional[TIdePeriodo] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
