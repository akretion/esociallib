...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtFechaEvPer/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class InfoFechIndExcApur1250(Enum):
    """Indicativo de exclusão de apuração das aquisições de produção rural (eventos
    S-1250) do período de apuração.
...
class InfoFechNaoValid(Enum):
    """Indicativo de não validação das regras de fechamento, para que os grandes
    contribuintes possam reduzir o tempo de processamento do evento.
...
class ESocial:
    ...
    :ivar evtFechaEvPer: Evento Fechamento dos Eventos Periódicos.
    ...
    evtFechaEvPer: Optional["ESocial.EvtFechaEvPer"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtFechaEvPer:
        ...
        :ivar Id:
        """
        ideEvento: Optional[TIdeEventoFolhaSemRetificacao] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        infoFech: Optional["ESocial.EvtFechaEvPer.InfoFech"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class InfoFech:
            """
            :ivar evtRemun: Possui informações relativas a remuneração
            ...
            :ivar evtPgtos: Possui informações de pagamento de
                rendimentos do trabalho no período de apuração?
                Validação: Se for igual a [S], deve existir o evento
                S-1210 para o período de apuração, considerando o campo
                {indGuia}(1299_ideEvento_indGuia). Caso contrário, não
                deve existir o evento.
            :ivar evtComProd: Possui informações de comercialização de
            ...
            :ivar evtContratAvNP: Contratou, por intermédio de
            ...
            :ivar evtInfoComplPer: Possui informações de desoneração de
                folha de pagamento ou, sendo empresa enquadrada no
            ...
            :ivar naoValid:
            """
            evtRemun: Optional[TsSimNao] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            evtPgtos: Optional[TsSimNao] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            evtComProd: Optional[TsSimNao] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            evtContratAvNP: Optional[TsSimNao] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            evtInfoComplPer: Optional[TsSimNao] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            indExcApur1250: Optional[InfoFechIndExcApur1250] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            transDCTFWeb: Optional[InfoFechTransDctfweb] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            naoValid: Optional[InfoFechNaoValid] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
