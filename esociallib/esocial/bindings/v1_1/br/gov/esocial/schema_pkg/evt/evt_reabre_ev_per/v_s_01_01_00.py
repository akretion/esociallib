...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtReabreEvPer/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ESocial:
    ...
    :ivar evtReabreEvPer: Evento Reabertura dos Eventos Periódicos.
    ...
    evtReabreEvPer: Optional["ESocial.EvtReabreEvPer"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
