...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtReintegr/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class InfoReintegrTpReint(Enum):
    ...
    Validação: Os tipos [3, 4, 5] só podem ser informados se a natureza jurídica do declarante for Administração Pública (grupo [1]).
...
class ESocial:
    ...
    :ivar evtReintegr: Evento Reintegração/Outros Provimentos.
    ...
    evtReintegr: Optional["ESocial.EvtReintegr"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtReintegr:
        ...
        :ivar ideEmpregador:
        :ivar ideVinculo:
        :ivar infoReintegr: Informações da reintegração. CHAVE_GRUPO:
            {dtEfetRetorno*}
        :ivar Id:
        """
        ...
        infoReintegr: Optional["ESocial.EvtReintegr.InfoReintegr"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class InfoReintegr:
            """
            :ivar tpReint:
            :ivar nrProcJud: Em caso de reintegração por determinação
                judicial, preencher com o número do processo. Validação:
                Informação obrigatória e exclusiva se
                {tpReint}(./tpReint) = [1]. Se preenchido, deve ser um
                processo judicial válido, com 20 (vinte) algarismos.
            :ivar nrLeiAnistia:
            :ivar dtEfetRetorno: Informar a data do efetivo retorno ao
                trabalho. Validação: Deve ser uma data válida, posterior
                à data de desligamento do trabalhador. Não pode ser
                posterior a 30 (trinta) dias da data atual.
            :ivar dtEfeito: Informar a data de início dos efeitos
                financeiros da reintegração. Validação: Deve ser uma
                data igual ou anterior à data do efetivo retorno ao
                trabalho e posterior à data do desligamento.
            """
            tpReint: Optional[InfoReintegrTpReint] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            nrLeiAnistia: Optional[str] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "pattern": r"\w{5,13}",
            ...
            dtEfetRetorno: Optional[XmlDate] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            dtEfeito: Optional[XmlDate] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
