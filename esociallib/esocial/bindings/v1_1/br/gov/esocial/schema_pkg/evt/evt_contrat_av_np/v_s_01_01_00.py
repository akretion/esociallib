...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtContratAvNP/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ESocial:
    ...
    :ivar evtContratAvNP: Evento Contratação de Trabalhadores Avulsos
        Não Portuários. CHAVE_GRUPO: {Id}
    ...
    evtContratAvNP: Optional["ESocial.EvtContratAvNp"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    @dataclass
    class EvtContratAvNp:
        """
        :ivar ideEvento:
        :ivar ideEmpregador:
        :ivar remunAvNP: Remuneração dos trabalhadores avulsos não
            portuários DESCRICAO_COMPLETA:Grupo que apresenta a
            remuneração dos trabalhadores avulsos não portuários, de
            forma totalizada por estabelecimento contratante.
        ...
        class RemunAvNp:
            ...
            :ivar tpInsc: Preencher com o código correspondente ao tipo
                de inscrição, conforme Tabela 05.
            :ivar nrInsc: Informar o número de inscrição do
                estabelecimento do contribuinte de acordo com o tipo de
                inscrição indicado no campo
                {remunAvNP/tpInsc}(./tpInsc). Validação: Deve ser um
                número de inscrição válido e existente na Tabela de
            ...
            :ivar codLotacao: Informar o código atribuído pelo
                ...
                Tributárias (S-1020).
            :ivar vrBcCp00: Valor da base de cálculo da contribuição
                previdenciária sobre a remuneração dos trabalhadores
                avulsos não portuários.
            :ivar vrBcCp15: Valor da base de cálculo da contribuição
                adicional para o financiamento dos benefícios de
                aposentadoria especial após 15 anos de contribuição.
            :ivar vrBcCp20: Valor da base de cálculo da contribuição
                adicional para o financiamento dos benefícios de
                aposentadoria especial após 20 anos de contribuição.
            :ivar vrBcCp25: Valor da base de cálculo da contribuição
                adicional para o financiamento dos benefícios de
                aposentadoria especial após 25 anos de contribuição.
            :ivar vrBcCp13: Valor da base de cálculo da contribuição
                previdenciária sobre o 13° salário dos trabalhadores
                avulsos não portuários contratados.
            :ivar vrBcFgts: Valor da base de cálculo do FGTS sobre a
                remuneração dos trabalhadores avulsos não portuários
                contratados.
            :ivar vrDescCP: Preencher com o valor total da contribuição
                descontada dos trabalhadores avulsos não portuários.
            """
            tpInsc: Optional[TsTpInsc134] = field(
                default=None,
                metadata={
