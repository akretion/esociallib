...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtAfastTemp/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class InfoMandSindInfOnusRemun(Enum):
    ...
    :cvar VALUE_3: Parte do empregador, sendo a diferença e/ou
        complementação salarial paga pelo sindicato
    """
    VALUE_1 = 1
    VALUE_2 = 2
    VALUE_3 = 3
...
class ESocial:
    ...
    :ivar evtAfastTemp: Evento Afastamento Temporário. CHAVE_GRUPO: {Id}
        REGRA:REGRA_AFASTAMENTO REGRA:REGRA_EMPREGADO_DOMESTICO
    ...
    evtAfastTemp: Optional["ESocial.EvtAfastTemp"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtAfastTemp:
        ...
        :ivar ideEvento:
        :ivar ideEmpregador:
        :ivar ideVinculo: Informações de identificação do trabalhador e
            do vínculo. CHAVE_GRUPO: {cpfTrab*}, {matricula*},
            {codCateg*}
        ...
        ideVinculo: Optional["ESocial.EvtAfastTemp.IdeVinculo"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        infoAfastamento: Optional["ESocial.EvtAfastTemp.InfoAfastamento"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class IdeVinculo:
            ...
            :ivar matricula: Matrícula atribuída ao trabalhador pela
                ...
                Humanos do órgão. Validação: Deve corresponder à
                matrícula informada pelo empregador no evento S-2200 ou
                S-2300 do respectivo contrato. Não preencher no caso de
                Trabalhador Sem Vínculo de Emprego/Estatutário - TSVE
                sem informação de matrícula no evento S-2300.
            :ivar codCateg: Preencher com o código da categoria do
                trabalhador. Informar somente no caso de TSVE sem
                informação de matrícula no evento S-2300. Validação:
                Informação obrigatória e exclusiva se não houver
                preenchimento de {matricula}(./matricula). Se informado,
        ...
        class InfoAfastamento:
            """
            :ivar iniAfastamento: Informações de início do afastamento.
                CHAVE_GRUPO: {dtIniAfast*} CONDICAO_GRUPO: O (se não for
                preenchido o grupo {fimAfastamento}(../fimAfastamento));
                OC (nos demais casos)
            :ivar infoRetif: Informações de retificação do afastamento
                DESCRICAO_COMPLETA:Informações de retificação do
                afastamento temporário. Preenchimento obrigatório caso
                {codMotAfast}(../iniAfastamento_codMotAfast) seja
                retificado de [01] para [03] ou de [03] para [01].
                CONDICAO_GRUPO: OC ((se
                {indRetif}(2230_ideEvento_indRetif) = [2]) E (o grupo
                {iniAfastamento}(../iniAfastamento) estiver preenchido);
                N (nos demais casos)
            :ivar fimAfastamento: Informação do término do afastamento.
                CHAVE_GRUPO: {dtTermAfast*} CONDICAO_GRUPO: O (se não
                for preenchido o grupo
                {iniAfastamento}(../iniAfastamento)); OC (nos demais
                casos) REGRA:REGRA_EXISTE_EVENTO_AFASTAMENTO
            """
            iniAfastamento: Optional["ESocial.EvtAfastTemp.InfoAfastamento.IniAfastamento"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            infoRetif: Optional["ESocial.EvtAfastTemp.InfoAfastamento.InfoRetif"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            fimAfastamento: Optional["ESocial.EvtAfastTemp.InfoAfastamento.FimAfastamento"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            ...
            class IniAfastamento:
                ...
                :ivar dtIniAfast: Data de início do afastamento.
                    Validação: Deve-se obedecer às seguintes regras: a)
                    Não pode ser posterior à data atual, exceto se: a1)
                    {codMotAfast}(./codMotAfast) = [15] (férias),
                    situação em que pode ser até 60 dias posterior à
                    data atual; a2) {codMotAfast}(./codMotAfast) = [18],
                    situação em que pode ser até 120 dias posterior à
                    data atual; b) É necessário que o trabalhador
                    esteja, antes da data de início do afastamento, em
                    atividade, ou seja, não pode existir evento de
                    afastamento anterior a {dtIniAfast}(./dtIniAfast)
                    sem que este tenha sido encerrado.
                :ivar codMotAfast:
                :ivar infoMesmoMtv: Informar se o afastamento decorre da
                    mesma doença que gerou o afastamento anterior
                    ({codMotAfast}(./codMotAfast) = [01, 03]), dentro de
                    60 dias.
                :ivar tpAcidTransito:
                :ivar observacao: Detalhar as informações sobre o
                    afastamento do trabalhador, de maneira a explicitar
                    os motivos do mesmo. Validação: O preenchimento é
                    obrigatório se {codMotAfast}(./codMotAfast) = [21].
                :ivar perAquis: Período aquisitivo de férias
                    DESCRICAO_COMPLETA:Informações referentes ao período
                    aquisitivo de férias. CONDICAO_GRUPO: O (se
                    {codMotAfast}(../codMotAfast) = [15] E (o código de
                    categoria no RET for igual a [1XX, 301, 302, 303,
                    304, 306, 307, 309, 310, 312, 410] com {tpRegTrab}
                    em S-2200/S-2300 = [1] OU o código de categoria no
                    RET for igual a [401] com
                    {tpRegTrab}(2300_infoTSVInicio_infoComplementares_infoDirigenteSindical_tpRegTrab)
                    em S-2300 = [1] ou não informado) E
                    {dtIniAfast}(../dtIniAfast) &gt;= [2021-07-19]); N
                    (nos demais casos)
                :ivar infoCessao: Informações complementares -
                    Cessão/Requisição de trabalhador. CONDICAO_GRUPO: O
                    (se {codMotAfast}(../codMotAfast) = [14]); N (nos
                    demais casos)
                :ivar infoMandSind: Informações complementares -
                    Afastamento para exercício de mandato sindical.
                    CONDICAO_GRUPO: O (se {codMotAfast}(../codMotAfast)
                    = [24]); N (nos demais casos)
                :ivar infoMandElet: Informações complementares -
                    Afastamento para exercício de mandato eletivo.
                    CONDICAO_GRUPO: O (se {codMotAfast}(../codMotAfast)
                    = [22] e se a natureza jurídica do declarante for
                    igual a 1XX-X, 201-1 ou 203-8); N (nos demais casos)
                """
                ...
                infoMesmoMtv: Optional[TsSimNao] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                )
                tpAcidTransito: Optional[IniAfastamentoTpAcidTransito] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                ...
                perAquis: Optional["ESocial.EvtAfastTemp.InfoAfastamento.IniAfastamento.PerAquis"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                )
                infoCessao: Optional["ESocial.EvtAfastTemp.InfoAfastamento.IniAfastamento.InfoCessao"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                )
                infoMandSind: Optional["ESocial.EvtAfastTemp.InfoAfastamento.IniAfastamento.InfoMandSind"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                )
                infoMandElet: Optional["ESocial.EvtAfastTemp.InfoAfastamento.IniAfastamento.InfoMandElet"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
                ...
                class PerAquis:
                    """
                    :ivar dtInicio: Data de início do período aquisitivo
                        de férias. Validação: Deve observar o que segue:
                        a) Se o código de categoria no Registro de
                        Eventos Trabalhistas - RET for diferente de
                        [304, 410], deve ser igual ou posterior a
                        {dtAdm}(2200_vinculo_infoRegimeTrab_infoCeletista_dtAdm);
                        b) Se o código de categoria no RET for igual a
                        [304], deve ser igual ou posterior a
                        {dtExercOrig}(2300_infoTSVInicio_infoComplementares_infoMandElet_dtExercOrig);
                        c) Se o código de categoria no RET for igual a
                        [410], deve ser igual ou posterior a
                        {dtAdmCed}(2300_infoTSVInicio_infoComplementares_infoTrabCedido_dtAdmCed).
                    :ivar dtFim: Data de término do período aquisitivo
                        de férias. É necessário informar o campo somente
                        se o período aquisitivo for diferente de 1 ano.
                        Validação: Se informada, deve ser uma data
                        posterior a {dtInicio}(./dtInicio).
                    """
                ...
                class InfoCessao:
                    """
                    :ivar cnpjCess: Preencher com o CNPJ do
                        órgão/entidade para o qual o trabalhador foi
                        cedido/requisitado. Validação: Deve ser um CNPJ
                        diferente do CNPJ do empregador e diferente dos
                        estabelecimentos informados através do evento
                        S-1005. REGRA:REGRA_VALIDA_CNPJ
                    :ivar infOnus:
                    """
                    cnpjCess: Optional[str] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                            "required": True,
                    ...
                    infOnus: Optional[InfoCessaoInfOnus] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                            "required": True,
                ...
                class InfoMandSind:
                    """
                    :ivar cnpjSind: CNPJ do sindicato no qual o
                        trabalhador exercerá o mandato. Validação: Deve
                        ser um CNPJ diferente do CNPJ base do empregador
                        e diferente dos informados na Tabela de
                        Estabelecimentos (S-1005).
                        REGRA:REGRA_VALIDA_CNPJ
                    :ivar infOnusRemun:
                    """
                    cnpjSind: Optional[str] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                            "required": True,
                    ...
                    infOnusRemun: Optional[InfoMandSindInfOnusRemun] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                            "required": True,
                ...
                class InfoMandElet:
                    """
                    :ivar cnpjMandElet: CNPJ do órgão no qual o
                        trabalhador exercerá o mandato eletivo.
                        REGRA:REGRA_VALIDA_CNPJ
                    :ivar indRemunCargo: Indicar se o servidor optou
                        pela remuneração do cargo efetivo. Validação:
                        Informação obrigatória e exclusiva se o código
                        de categoria no Registro de Eventos Trabalhistas
                        - RET for igual a [301].
                    """
                    cnpjMandElet: Optional[str] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                            "required": True,
            ...
            @dataclass
            class InfoRetif:
                origRetif: Optional[InfoRetifOrigRetif] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
                ...
                tpProc: Optional[InfoRetifTpProc] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
            ...
            @dataclass
            class FimAfastamento:
                """
                :ivar dtTermAfast: Preencher com a data do término do
                    afastamento do trabalhador. Validação: Deve ser
                    igual ou posterior à data de início do afastamento
                    do trabalhador e anterior a [9999-12-31].
                """
                dtTermAfast: Optional[XmlDate] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
