...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtCessao/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ESocial:
    ...
    :ivar evtCessao: Evento Cessão/Exercício em Outro Órgão.
    ...
    evtCessao: Optional["ESocial.EvtCessao"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtCessao:
        ...
        :ivar ideEmpregador:
        :ivar ideVinculo:
        :ivar infoCessao: Informações da cessão/exercício em outro
            órgão.
        :ivar Id:
        """
        ...
        infoCessao: Optional["ESocial.EvtCessao.InfoCessao"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class InfoCessao:
            """
            :ivar iniCessao: Informações de início da cessão/exercício
                em outro órgão. CHAVE_GRUPO: {dtIniCessao*}
                CONDICAO_GRUPO: O (se não for preenchido o grupo
                {fimCessao}(../fimCessao)); N (nos demais casos)
            :ivar fimCessao: Informação de término da cessão/exercício
                em outro órgão. CHAVE_GRUPO: {dtTermCessao*}
                CONDICAO_GRUPO: O (se não for preenchido o grupo
                {iniCessao}(../iniCessao)); N (nos demais casos)
                REGRA:REGRA_EXISTE_EVENTO_CESSAO
            """
            iniCessao: Optional["ESocial.EvtCessao.InfoCessao.IniCessao"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            fimCessao: Optional["ESocial.EvtCessao.InfoCessao.FimCessao"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            ...
            class IniCessao:
                ...
                :ivar dtIniCessao: Data de início da cessão/exercício em
                    outro órgão. Validação: Deve-se obedecer às
                    seguintes regras: a) Não pode ser posterior à data
                    atual; b) Não pode existir evento de
                    cessão/exercício em outro órgão (ou evento de
                    afastamento pelo código de motivo de afastamento
                    [14]) com data anterior a
                    {dtIniCessao}(./dtIniCessao) sem que tenha sido
                    encerrado.
                :ivar cnpjCess: Preencher com o CNPJ do empregador/órgão
                    público cessionário/de destino. Validação: Deve ser
                    um CNPJ diferente do CNPJ do empregador/órgão
                    público e diferente dos estabelecimentos informados
                    através do evento S-1005. REGRA:REGRA_VALIDA_CNPJ
                :ivar respRemun: Informar se o empregador/órgão público
                    declarante continuará informando remunerações
                    (S-1200/S-1202) do trabalhador cedido/em exercício
                    em outro órgão.
                """
                ...
                respRemun: Optional[TsSimNao] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
            ...
            class FimCessao:
                """
                :ivar dtTermCessao: Preencher com a data de término da
                    cessão/exercício em outro órgão. Validação: Deve-se
                    obedecer às seguintes regras: a) Deve ser igual ou
                    posterior à data de início da cessão/exercício em
                    outro órgão; b) Não pode ser posterior à data atual.
                """
                dtTermCessao: Optional[XmlDate] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                        "required": True,
