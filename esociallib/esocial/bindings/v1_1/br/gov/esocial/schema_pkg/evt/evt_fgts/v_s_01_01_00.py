...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtFGTS/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class InfoFgtsIndExistInfo(Enum):
    ...
    :cvar VALUE_3: Não há movimento no período informado em
        {perApur}(5013_ideEvento_perApur)
    """
    VALUE_1 = 1
    VALUE_2 = 2
    VALUE_3 = 3
...
class ESocial:
    ...
    :ivar evtFGTS: Evento Informações do FGTS Consolidadas por
        Contribuinte. CHAVE_GRUPO: {Id}
    :ivar signature:
    """
    class Meta:
        name = "eSocial"
    ...
    evtFGTS: Optional["ESocial.EvtFgts"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtFgts:
        ...
        infoFGTS: Optional["ESocial.EvtFgts.InfoFgts"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class InfoFgts:
            ...
            indExistInfo: Optional[InfoFgtsIndExistInfo] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            class IdeEstab:
                ...
                class IdeLotacao:
                    ...
                    :ivar infoBaseFGTS: Bases de cálculo e valores do
                        FGTS DESCRICAO_COMPLETA:Informações referentes a
                        bases de cálculo e valores do FGTS no
                        estabelecimento/lotação. CONDICAO_GRUPO: OC
                    """
                    ...
                    infoBaseFGTS: Optional["ESocial.EvtFgts.InfoFgts.IdeEstab.IdeLotacao.InfoBaseFgts"] = field(
                        default=None,
                        metadata={
                            "type": "Element",
                        }
                    ...
                    class InfoBaseFgts:
                        """
                        :ivar basePerApur: Bases de cálculo e valores do
                            FGTS, exceto se {tpAcConv} = [E, H]
                            DESCRICAO_COMPLETA:Informações consolidadas
                            das bases de cálculo e valores do FGTS do
                            período de apuração e de períodos
                            anteriores, exceto se {tpAcConv} = [E, H].
                            Evento de origem: S-1270 ou S-5003.
                            CHAVE_GRUPO: {tpValor}, {indIncid}
                            CONDICAO_GRUPO: OC
                        :ivar infoBasePerAntE: Informações sobre bases
                            de cálculo e valores do FGTS, quando
                            ...
                            FGTS de períodos anteriores quando
                            {tpAcConv}(./tpAcConv) = [E, H]. Evento de
                            origem: S-5003. CHAVE_GRUPO: {perRef},
                            {tpAcConv} CONDICAO_GRUPO: OC
                        """
                        basePerApur: List["ESocial.EvtFgts.InfoFgts.IdeEstab.IdeLotacao.InfoBaseFgts.BasePerApur"] = field(
                            default_factory=list,
                            metadata={
                                "type": "Element",
                                "max_occurs": 99,
                        ...
                        infoBasePerAntE: List["ESocial.EvtFgts.InfoFgts.IdeEstab.IdeLotacao.InfoBaseFgts.InfoBasePerAntE"] = field(
                            default_factory=list,
                            metadata={
                                "type": "Element",
                                "max_occurs": 180,
                        ...
                        class BasePerApur:
                            """
                            :ivar tpValor:
                            :ivar indIncid: Indicativo de incidência de
                                FGTS. Validação: Se {tpValor}(./tpValor)
                                for diferente de [19], deve corresponder
                                ao valor informado no campo
                                {indIncid}(5003_infoFGTS_ideEstab_ideLotacao_infoTrabFGTS_infoBaseFGTS_basePerApur_indIncid)
                                do evento S-5003. Se
                                {tpValor}(./tpValor) = [19], deve ser
                                retornado [1].
                            :ivar baseFGTS: Remuneração (valor da base
                                de cálculo) do FGTS. Validação: Deve ser
                                maior que 0 (zero). Se
                                {tpValor}(./tpValor) for diferente de
                                [19], deve corresponder ao somatório dos
                                valores informados no campo
                                {remFGTS}(5003_infoFGTS_ideEstab_ideLotacao_infoTrabFGTS_infoBaseFGTS_basePerApur_remFGTS)
                                do evento S-5003, agrupados por
                                {tpValor}(./tpValor) e
                                {indIncid}(./indIncid). Se
                                {tpValor}(./tpValor) = [19], deve
                                corresponder à remuneração dos
                                trabalhadores avulsos não portuários
                                contratados, conforme informado no campo
                                {vrBcFGTS}(1270_remunAvNP_vrBcFgts) do
                                evento S-1270.
                            :ivar vrFGTS: Valor histórico do FGTS a ser
                                depositado na conta vinculada do
                                trabalhador. Validação: Deve ser maior
                                que 0 (zero). Se {tpValor}(./tpValor)
                                for diferente de [19], deve corresponder
                                ao somatório dos valores informados no
                                campo
                            ...
                            baseFGTS: Optional[Decimal] = field(
                                default=None,
                                metadata={
                                    "type": "Element",
                                    "required": True,
                        ...
                        class InfoBasePerAntE:
                            ...
                            :ivar perRef: Informar o período ao qual se
                                refere a remuneração no formato AAAA-MM.
                                Validação: Deve corresponder ao período
                                informado no evento de origem.
                            :ivar tpAcConv:
                            :ivar basePerAntE: Bases de cálculo e
                                valores do FGTS, quando
                                {tpAcConv}(5013_infoFGTS_ideEstab_ideLotacao_infoBaseFGTS_infoBasePerAntE_tpAcConv)
                                = [E, H] DESCRICAO_COMPLETA:Informações
                                consolidadas das bases de cálculo e
                                valores do FGTS de períodos anteriores
                            ...
                            basePerAntE: List["ESocial.EvtFgts.InfoFgts.IdeEstab.IdeLotacao.InfoBaseFgts.InfoBasePerAntE.BasePerAntE"] = field(
                                default_factory=list,
                                metadata={
                                    "type": "Element",
                                    "min_occurs": 1,
                            ...
                            class BasePerAntE:
                                """
                                :ivar tpValorE: Tipo de valor que influi
                                    na apuração do FGTS. Validação: Deve
                                    corresponder ao valor informado no
                                    campo
                                    {tpValorE}(5003_infoFGTS_ideEstab_ideLotacao_infoTrabFGTS_infoBaseFGTS_infoBasePerAntE_basePerAntE_tpValorE)
                                    do evento de origem.
                                :ivar indIncidE: Indicativo de
                                    incidência de FGTS. Validação: Deve
                                    corresponder ao valor informado no
                                    campo
                                    {indIncidE}(5003_infoFGTS_ideEstab_ideLotacao_infoTrabFGTS_infoBaseFGTS_infoBasePerAntE_basePerAntE_indIncidE)
                                    do evento de origem.
                                :ivar baseFGTSE: Remuneração (valor da
                                    base de cálculo) do FGTS. Validação:
                                    ...
                                    do evento de origem, agrupados por
                                    {tpValorE}(./tpValorE) e
                                    {indIncidE}(./indIncidE).
                                :ivar vrFGTSE: Valor histórico do FGTS a
                                    ser depositado na conta vinculada do
                                    trabalhador. Validação: Deve ser
                                    maior que 0 (zero). Deve
                                    corresponder ao somatório dos
                                    valores informados no campo
                                ...
                                baseFGTSE: Optional[Decimal] = field(
                                    default=None,
                                    metadata={
                                        "type": "Element",
                                        "required": True,
                                ...
                                vrFGTSE: Optional[Decimal] = field(
                                    default=None,
                                    metadata={
                                        "type": "Element",
                                        "min_exclusive": Decimal("0"),
