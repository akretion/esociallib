...
class TAlvaraJudicial:
    ...
    nrProcJud: Optional[str] = field(
        ...
        metadata={
            "type": "Element",
            "namespace": "http://www.esocial.gov.br/schema/evt/evtExcProcTrab/v_S_01_01_00",
            "required": True,
            "length": 20,
        }
    )
...
class ESocial:
    ...
    :ivar evtExcProcTrab: Evento Exclusão DESCRICAO_COMPLETA:Evento
        Exclusão de Eventos - Processo Trabalhista. CHAVE_GRUPO: {Id}
    ...
    evtExcProcTrab: Optional["ESocial.EvtExcProcTrab"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtExcProcTrab:
        ...
        :ivar ideEvento:
        :ivar ideEmpregador:
        :ivar infoExclusao: Informação do evento que será excluído
            DESCRICAO_COMPLETA:Grupo que identifica o evento objeto da
            exclusão.
        :ivar Id:
        """
        ideEvento: Optional[TIdeEventoExclusaoProcTrab] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        ideEmpregador: Optional[TIdeEmpregadorExclusao] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        infoExclusao: Optional["ESocial.EvtExcProcTrab.InfoExclusao"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class InfoExclusao:
            """
            :ivar tpEvento:
            :ivar nrRecEvt: Preencher com o número do recibo do evento
                que será excluído. Validação: O recibo deve ser relativo
                ao mesmo tipo de evento indicado em
                {tpEvento}(./tpEvento).
            :ivar ideProcTrab: Identificação do processo, do trabalhador
                e do período de apuração.
                DESCRICAO_COMPLETA:Identificação do processo, do
                trabalhador e do período a que se refere o evento que
                será excluído.
            """
            ...
            ideProcTrab: Optional["ESocial.EvtExcProcTrab.InfoExclusao.IdeProcTrab"] = field(
                default=None,
                metadata={
                    "type": "Element",
                    "required": True,
            ...
            class IdeProcTrab:
                """
                :ivar nrProcTrab: Número do processo trabalhista, da ata
                    ou número de identificação da conciliação.
                    Validação: Deve ser o mesmo número do processo
                    informado no evento objeto da exclusão.
                :ivar cpfTrab: Preencher com o número do CPF do
                    trabalhador. Validação: Preenchimento obrigatório e
                    exclusivo se {tpEvento}(../tpEvento) = [S-2500].
                    Deve ser o mesmo CPF informado no evento S-2500
                    objeto da exclusão.
                :ivar perApurPgto: Mês/ano em que é devida a obrigação
                    de pagar a parcela prevista no acordo/sentença.
                    Validação: Preenchimento obrigatório e exclusivo se
                    {tpEvento}(../tpEvento) = [S-2501]. Deve ser o mesmo
                    período informado no evento S-2501 objeto da
                    exclusão.
                """
