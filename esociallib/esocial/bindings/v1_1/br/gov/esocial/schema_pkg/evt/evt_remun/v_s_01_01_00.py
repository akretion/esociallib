...
class TItensRemun:
    ...
    :ivar fatorRubr:
    :ivar vrRubr:
    :ivar indApurIR: Indicativo de tipo de apuração de IR. Validação:
...
class ESocial:
    ...
    :ivar evtRemun: Evento Remuneração de Trabalhador vinculado ao RGPS
    ...
    evtRemun: Optional["ESocial.EvtRemun"] = field(
        default=None,
        metadata={
            "type": "Element",
            "required": True,
    ...
    class EvtRemun:
        ...
        ideTrabalhador: Optional["ESocial.EvtRemun.IdeTrabalhador"] = field(
            default=None,
            metadata={
                "type": "Element",
                "required": True,
        ...
        class IdeTrabalhador:
            """
            :ivar cpfTrab:
            :ivar infoMV: Informação de múltiplos vínculos
            ...
            infoMV: Optional["ESocial.EvtRemun.IdeTrabalhador.InfoMv"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            infoComplem: Optional["ESocial.EvtRemun.IdeTrabalhador.InfoComplem"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            ...
            class InfoMv:
                """
                :ivar indMV:
                :ivar remunOutrEmpr: Remuneração recebida pelo
            ...
            class InfoComplem:
                ...
                sucessaoVinc: Optional["ESocial.EvtRemun.IdeTrabalhador.InfoComplem.SucessaoVinc"] = field(
                    default=None,
                    metadata={
                        "type": "Element",
                    }
        ...
        class DmDev:
            """
            :ivar ideDmDev: Identificador atribuído pela empresa para o
                demonstrativo de valores devidos ao trabalhador. O
            ...
            :ivar infoPerAnt: Informações relativas a períodos
                ...
                (nos demais casos)
            :ivar infoComplCont: Informações complementares contratuais
                do trabalhador DESCRICAO_COMPLETA:Grupo preenchido
                exclusivamente quando o evento de remuneração se referir
                a trabalhador cuja categoria não estiver obrigada ao
                evento de início de TSVE e se não houver evento S-2300
                correspondente. CONDICAO_GRUPO: O ((se
            ...
            infoPerApur: Optional["ESocial.EvtRemun.DmDev.InfoPerApur"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            infoPerAnt: Optional["ESocial.EvtRemun.DmDev.InfoPerAnt"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            )
            infoComplCont: Optional["ESocial.EvtRemun.DmDev.InfoComplCont"] = field(
                default=None,
                metadata={
                    "type": "Element",
                }
            ...
            class InfoPerApur:
                """
                :ivar ideEstabLot: Identificação do estabelecimento e
                ...
                class IdeEstabLot:
                    ...
                    :ivar nrInsc:
                    :ivar codLotacao:
                    :ivar qtdDiasAv: Quantidade de dias trabalhados no
                    ...
                    class RemunPerApur:
                        ...
                        :ivar indSimples:
                        :ivar itensRemun:
                        :ivar infoAgNocivo: Grau de exposição a agentes
                            nocivos DESCRICAO_COMPLETA:Grupo referente
                            ao detalhamento do grau de exposição do
                            trabalhador aos agentes nocivos que ensejam
                            a cobrança da contribuição adicional para
                            financiamento dos benefícios de
                            aposentadoria especial. CONDICAO_GRUPO: O
                        ...
                        infoAgNocivo: Optional[TInfoAgNocivo] = field(
                            default=None,
                            metadata={
                                "type": "Element",
                            }
            ...
            class InfoPerAnt:
                """
                :ivar ideADC: Instrumento ou situação ensejadora da
                ...
                class IdeAdc:
                    """
                    :ivar dtAcConv:
                    :ivar tpAcConv: Tipo do instrumento ou situação
                    ...
                    class IdePeriodo:
                        ...
                        class IdeEstabLot:
                            ...
                            :ivar nrInsc:
                            :ivar codLotacao:
                            :ivar remunPerAnt: Remuneração do
                                trabalhador
                            ...
                            remunPerAnt: List["ESocial.EvtRemun.DmDev.InfoPerAnt.IdeAdc.IdePeriodo.IdeEstabLot.RemunPerAnt"] = field(
                                default_factory=list,
                                metadata={
                                    "type": "Element",
                                    "min_occurs": 1,
            ...
            class InfoComplCont:
                ...
                :ivar natAtividade: Natureza da atividade. Validação: O
                ...
                :ivar qtdDiasTrab: Informação prestada exclusivamente
